...
Tested under Windows 10 and Windows Server 2016.
Prerequisites:
- Visual Studio (tested with Visual Studio 2017)
- CMake (tested with CMake version 3.16.2)
...
- Visual Studio version to use and type of build (Release, Debug, etc.). Set the VS_VERSION adn CONFIG variables.
...
- The sopc_common_build_info.c file is usually generated by CMake,
   it is possible to use a copy of src/Common/configuration/sopc_common_build_info.c_ instead and to add it to the build
- The s2opc_common_export.h file is usually generated by CMake,
   it is possible to use a copy of src/Common/helpers_platform_dep/<platform>/s2opc_common_export.h_ instead and add it to the build
