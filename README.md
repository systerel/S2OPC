...
- [Mbedtls](https://tls.mbed.org/)(tested with mbedtls version 3.6.2) or  [CycloneCRYPTO](https://gitlab.com/systerel/S2OPC/-/wikis/compilation/Compilation-of-CycloneCRYPTO-(Linux)) (tested with patched version 2.2.4)
