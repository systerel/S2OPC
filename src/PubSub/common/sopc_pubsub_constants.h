...
#define SOPC_MAX_LENGTH_UINT8_TO_STRING 4 /* 2^8 = 256 maximum number you could represent plus \0 at the end */
...
#define SOPC_MAX_LENGTH_INT16_TO_STRING                                                                             \
    7 /* 2^15 = 32768 maximum number you could represent using maximum chars would be 65536 plus \0 at the end plus \
         '-' */
#define SOPC_MAX_LENGTH_INT8_TO_STRING 5 /* 2^7 = 128 maximum number you could represent plus \0 at the end plus '-'*/
