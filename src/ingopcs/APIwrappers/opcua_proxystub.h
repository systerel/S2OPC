...
#define OPCUA_TRACE_OUTPUT_LEVEL_ERROR   0
#define OPCUA_TRACE_OUTPUT_LEVEL_WARNING 0
#define OPCUA_TRACE_OUTPUT_LEVEL_SYSTEM  0
#define OPCUA_TRACE_OUTPUT_LEVEL_INFO    0
#define OPCUA_TRACE_OUTPUT_LEVEL_DEBUG   0
#define OPCUA_TRACE_OUTPUT_LEVEL_CONTENT 0
#define OPCUA_TRACE_OUTPUT_LEVEL_ALL     0
#define OPCUA_TRACE_OUTPUT_LEVEL_NONE    0
...
OpcUa_StatusCode OpcUa_ProxyStub_Initialize( OpcUa_Handle                    pPortLayerHandle,
...
OpcUa_StatusCode OpcUa_ProxyStub_ReInitialize( OpcUa_ProxyStubConfiguration*   pProxyStubConfiguration);

/*============================================================================
 * OpcUa_ProxyStub_Clear
 *===========================================================================*/
/** Clean up proxy stub library. */
OpcUa_Void OpcUa_ProxyStub_Clear();
...
/** Add additional types to the known types table.
  ...
  */
OpcUa_StatusCode OpcUa_ProxyStub_AddTypes(OpcUa_EncodeableType** ppTypes);
...
/** Request the version string of the proxy stub.
  ...
  */
//OpcUa_StringA OpcUa_ProxyStub_GetVersion();
...
/** Request the string encoded configuration table.
  ...
  */
//OpcUa_StringA OpcUa_ProxyStub_GetConfigString();
...
/** Request the string encoded built configuration of the stack.
  ...
  */
//OpcUa_StringA OpcUa_ProxyStub_GetStaticConfigString();
