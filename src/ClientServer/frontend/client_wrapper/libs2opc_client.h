...
/**
 ...
 @var SOPC_LibSub_ConnectionCfg::reverse_config_idx
   If the reverse connection mechanism shall be used, it shall be set with the index of the reverse endpoint
   configuration. Otherwise it shall be set to 0.
