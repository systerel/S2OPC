...
#define SOPC_USER_TOKEN_POLICY_ANONYMOUS                                                                 \
    {                                                                                                    \
        .TokenType = OpcUa_UserTokenType_Anonymous, .PolicyId = {9, true, (SOPC_Byte*) "anonymous"},     \
        .IssuedTokenType = {0, true, NULL}, .IssuerEndpointUrl = {0, true, NULL}, .SecurityPolicyUri = { \
            0,                                                                                           \
            true,                                                                                        \
            NULL                                                                                         \
        }                                                                                                \
...
#define SOPC_USER_TOKEN_POLICY_USERNAME                                                                  \
    {                                                                                                    \
        .TokenType = OpcUa_UserTokenType_UserName, .PolicyId = {8, true, (SOPC_Byte*) "username"},       \
        .IssuedTokenType = {0, true, NULL}, .IssuerEndpointUrl = {0, true, NULL}, .SecurityPolicyUri = { \
            sizeof(SOPC_SecurityPolicy_None_URI) - 1,                                                    \
            true,                                                                                        \
            (SOPC_Byte*) SOPC_SecurityPolicy_None_URI                                                    \
        }                                                                                                \
    }
/* Note: None security policy shall be used only when secure channel security policy is non-None since password will be
 * non-encrypted */

/** Anonymous user security policy supported configuration */
const OpcUa_UserTokenPolicy c_userTokenPolicy_Anonymous = SOPC_USER_TOKEN_POLICY_ANONYMOUS;
const OpcUa_UserTokenPolicy SOPC_UserTokenPolicy_Anonymous = SOPC_USER_TOKEN_POLICY_ANONYMOUS;
...
const OpcUa_UserTokenPolicy c_userTokenPolicy_UserName_NoneSecurityPolicy = SOPC_USER_TOKEN_POLICY_USERNAME;
const OpcUa_UserTokenPolicy SOPC_UserTokenPolicy_UserName_NoneSecurityPolicy = SOPC_USER_TOKEN_POLICY_USERNAME;
