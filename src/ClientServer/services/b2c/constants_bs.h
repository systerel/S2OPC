...
extern const constants_bs__t_NodeId_i constants_bs__c_RefreshEndEventType_NodeId;
extern const constants_bs__t_NodeId_i constants_bs__c_RefreshRequiredEventType_NodeId;
extern const constants_bs__t_NodeId_i constants_bs__c_RefreshStartEventType_NodeId;
...
extern void constants_bs__get_copy_UserToken(const constants_bs__t_user_token_i constants_bs__p_in,
                                             t_bool* const constants_bs__p_alloc,
