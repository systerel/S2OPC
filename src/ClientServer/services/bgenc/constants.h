...
#define constants__t_eventFieldList_i constants_bs__t_eventFieldList_i
#define constants__t_filterResult_i constants_bs__t_filterResult_i
...
#define constants__t_eventFieldList_i_max constants_bs__t_eventFieldList_i_max
#define constants__t_filterResult_i_max constants_bs__t_filterResult_i_max
...
#define constants__c_BaseEventType_NodeId constants_bs__c_BaseEventType_NodeId
...
#define constants__c_channel_lock_create_session_delay constants_bs__c_channel_lock_create_session_delay
...
#define constants__c_eventFieldList_indet constants_bs__c_eventFieldList_indet
#define constants__c_filterResult_indet constants_bs__c_filterResult_indet
#define constants__c_max_channels_connected constants_bs__c_max_channels_connected
#define constants__c_max_sessions_per_channel constants_bs__c_max_sessions_per_channel
