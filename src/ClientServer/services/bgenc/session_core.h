...
#define session_core__get_server_session_client_app_desc session_core_1__get_server_session_client_app_desc
#define session_core__get_server_session_client_cert_tb session_core_1__get_server_session_client_cert_tb
#define session_core__get_server_session_name session_core_1__get_server_session_name
...
extern void session_core__l_server_create_session_req_and_resp_sm(
   const constants__t_session_i session_core__p_session,
   const constants__t_channel_i session_core__p_channel,
...
extern void session_core__may_close_unactivated_session(void);
...
extern void session_core__server_close_session_sm(
   const constants__t_session_i session_core__session,
   const constants_statuscodes_bs__t_StatusCode_i session_core__sc_reason);
extern void session_core__server_close_sessions(
...
extern void session_core__server_secure_channel_lost_session_sm(
   const constants__t_channel_i session_core__p_lost_channel);
extern void session_core__session_core_UNINITIALISATION(void);
