...
void session_core__l_server_write_create_session_resp(
   const constants__t_session_i session_core__p_session,
   const constants__t_channel_i session_core__p_channel,
   const constants__t_session_token_i session_core__p_session_token,
   const constants__t_msg_i session_core__create_req_msg,
   ...
   constants_statuscodes_bs__t_StatusCode_i * const session_core__p_service_ret) {
   {
      ...
      msg_session_bs__write_create_session_msg_server_endpoints(session_core__create_req_msg,
         session_core__create_resp_msg,
         session_core__l_endpoint_config_idx,
         session_core__p_service_ret);
      if (*session_core__p_service_ret == constants_statuscodes_bs__e_sc_ok) {
         channel_mgr__get_SecurityPolicy(session_core__p_channel,
            &session_core__l_secpol);
         if (session_core__l_secpol != constants__e_secpol_None) {
            ...
            if (session_core__l_crypto_status == constants_statuscodes_bs__e_sc_ok) {
               ...
               *session_core__p_service_ret = session_core__l_crypto_status;
            }
         }
         if (*session_core__p_service_ret == constants_statuscodes_bs__e_sc_ok) {
            ...
            if (session_core__l_bret == true) {
               session_core_1__server_set_fresh_nonce(session_core__p_session,
                  session_core__l_channel_config_idx,
                  &session_core__l_bret,
                  &session_core__l_nonce);
               if (session_core__l_bret == true) {
...
void session_core__l_server_create_session_req_and_resp_sm(
   const constants__t_session_i session_core__p_session,
   const constants__t_channel_i session_core__p_channel,
   const constants__t_msg_i session_core__create_req_msg,
   const constants__t_msg_i session_core__create_resp_msg,
   ...
   constants_statuscodes_bs__t_StatusCode_i * const session_core__p_service_ret) {
   {
      ...
      *session_core__nsession = constants__c_session_indet;
      ...
      if ((session_core__l_valid_session_token == true) &&
         ...
         *session_core__nsession = session_core__p_session;
         session_core__l_server_write_create_session_resp(session_core__p_session,
            session_core__p_channel,
            session_core__l_nsession_token,
            session_core__create_req_msg,
            session_core__create_resp_msg,
         ...
         if (session_core__l_valid_server_cert == true) {
            *session_core__p_service_ret = constants_statuscodes_bs__e_sc_bad_too_many_sessions;
         }
         else {
   ...
   constants_statuscodes_bs__t_StatusCode_i * const session_core__service_ret) {
   {
      ...
      *session_core__service_ret = constants_statuscodes_bs__e_sc_bad_out_of_memory;
      ...
      if (session_core__l_valid_session == true) {
         session_core__l_server_create_session_req_and_resp_sm(session_core__l_nsession,
            session_core__channel,
            session_core__create_req_msg,
            session_core__create_resp_msg,
            session_core__nsession,
...
void session_core__l_client_user_activate_session_req_sm(
   const constants__t_session_i session_core__p_session,
   const constants__t_channel_i session_core__p_channel,
   const constants__t_user_token_i session_core__p_user_token,
   const constants__t_msg_i session_core__activate_req_msg,
   ...
   constants__t_session_token_i * const session_core__p_session_token) {
   {
      ...
      *session_core__p_session_token = constants__c_session_token_indet;
      ...
      channel_mgr__get_channel_info(session_core__p_channel,
         &session_core__l_channel_config_idx);
      session_core_1__getall_NonceServer(session_core__p_session,
         true,
         &session_core__l_dom,
         &session_core__l_server_nonce);
      if (session_core__l_dom == true) {
         session_core_1__get_session_user_secu_client(session_core__p_session,
            &session_core__l_user_secu_policy);
         session_core_1__get_session_user_server_certificate(session_core__p_session,
         ...
         if (session_core__l_user_token_type == constants__e_userTokenType_userName) {
            if (session_core__l_user_secu_policy == constants__e_secpol_None) {
               ...
               session_core_1__may_validate_server_certificate(session_core__p_session,
                  session_core__l_channel_config_idx,
                  session_core__l_user_server_cert,
                  session_core__l_user_secu_policy,
            ...
            if (session_core__l_user_secu_policy != constants__e_secpol_None) {
               session_core_1__get_session_app_context(session_core__p_session,
                  &session_core__l_app_context);
         ...
         if (session_core__l_valid_encrypt == true) {
            ...
            channel_mgr__get_SecurityPolicy(session_core__p_channel,
               &session_core__l_secpol);
            if (session_core__l_secpol != constants__e_secpol_None) {
               session_core_1__client_activate_session_req_do_crypto(session_core__p_session,
                  session_core__l_channel_config_idx,
                  session_core__l_server_nonce,
               ...
               if (session_core__l_valid_crypto == true) {
                  ...
                  if (session_core__l_bret == true) {
                     msg_session_bs__write_activate_req_msg_locales(session_core__activate_req_msg,
                        session_core__l_channel_config_idx);
                     *session_core__p_ret = constants_statuscodes_bs__e_sc_ok;
                  }
                  else {
                     *session_core__p_ret = constants_statuscodes_bs__e_sc_bad_unexpected_error;
                  }
               }
               else {
                  *session_core__p_ret = constants_statuscodes_bs__e_sc_bad_security_checks_failed;
...
void session_core__client_user_activate_session_req_sm(
   ...
   constants__t_session_token_i * const session_core__session_token) {
   {
      ...
      if (session_core__l_is_connected_channel == true) {
         session_core__l_client_user_activate_session_req_sm(session_core__session,
            *session_core__channel,
            session_core__p_user_token,
            session_core__activate_req_msg,
            session_core__ret,
   ...
   const constants__t_channel_i session_core__p_lost_channel) {
   {
      ...
      if (session_core__l_continue == true) {
         while (session_core__l_continue == true) {
            ...
            if ((session_core__l_dom == true) &&
               (session_core__l_channel == session_core__p_lost_channel)) {
               session_core__l_server_secure_channel_lost_session_sm(session_core__l_session);
            }
         }
      }
