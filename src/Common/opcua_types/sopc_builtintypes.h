...
/** \brief Allocates and initializes a NodeId from a normalized C string. See SOPC_String_InitializeFromCString */
...
/** \brief Creates a thread safe dictionary which keys are \a NodeId.
 * \param free_keys True if the dictionary is responsible for deleting keys on element removal
 * \param value_copy The copy function to allocated and copy an element. (Can be null if no copy is required)
 * \param value_free The Free function for deleted elements. (Can be null if no deletion is required)
 */
