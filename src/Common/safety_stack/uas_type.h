 ...
 */
/**@{*/
#define UAS_SAFETY_DATA_LENGTH_MAX 1500uL /**< Maximum allowed length of serialized process data */
#define UAS_SAFETY_DATA_LENGTH_MIN 1uL    /**< Minimum allowed length of serialized process data */
/**@}*/
...
#define UAS_BITPOS_OPERATOR_ACK_PROVIDER  0u  /**< Bit position of signal 'OperatorAckProvider'  in ResponseSPDU.Flags */
#define UAS_BITPOS_OPERATOR_ACK_REQUESTED 1u  /**< Bit position of signal 'OperatorAckRequested' in RequestSPDU.Flags */
 ...
 */
/**@{*/
#define UAS_SAFETY_LEVEL_1_ID 0x11912881uL /**< SafetyProviderLevel_ID for SafetyProviderLevel up to SIL1 */
#define UAS_SAFETY_LEVEL_2_ID 0x647C4654uL /**< SafetyProviderLevel_ID for SafetyProviderLevel up to SIL2 */
#define UAS_SAFETY_LEVEL_3_ID 0xDEAA9DEEuL /**< SafetyProviderLevel_ID for SafetyProviderLevel up to SIL3 */
#define UAS_SAFETY_LEVEL_4_ID 0xAB47F33BuL /**< SafetyProviderLevel_ID for SafetyProviderLevel up to SIL4 */
/**@}*/
...
typedef enum UAS_SafetyDiagIdentifier_enum
{
  ...
  /** Mismatch of SafetyBaseID. The SafetyConsumer has switched to fail-safe substitute values due to an incorrect ID. Operator acknowledgment is required. */
  UAS_DIAG_SD_ID_ERR_OA_1     = 0x11,
  /** Mismatch of SafetyProviderID. The SafetyConsumer has switched to fail-safe substitute values due to an incorrect ID. Operator acknowledgment is required. */
  UAS_DIAG_SD_ID_ERR_OA_2     = 0x12,
  /** Mismatch of safety data structure or identifier. The SafetyConsumer has switched to fail-safe substitute values due to an incorrect ID. Operator acknowledgment is required. */
  UAS_DIAG_SD_ID_ERR_OA_3     = 0x13,
  /** Mismatch of SafetyProviderLevel. The SafetyConsumer has switched to fail-safe substitute values due to an incorrect ID. Operator acknowledgment is required. */
  UAS_DIAG_SD_ID_ERR_OA_4     = 0x14,
  /** The SafetyConsumer has discarded a message due to a CRC error (data corruption). */
  UAS_DIAG_CRC_ERR_IGN        = 0x05,
...
typedef struct UAS_SafetyProviderSPI_struct {
  ...
  /** Base-ID of the SafetyProvider, which is normally used, see Clause 3.2.25. and Clause 11.1.1.of the OPC UA Safety Specification. For dynamic systems, the safety application program can overwrite this ID by providing a non-zero value at the input SafetyBaseID of the SafetyProvider’ s SAPI. */
  ...
  /** SafetyStructureSignatureVersion is not used in the SafetyProvider instance */
  /** SafetyStructureIdentifier is not used in the SafetyProvider instance */
  /** SafetyProviderDelay is not used in the SafetyProvider instance */
...
typedef struct UAS_SafetyConsumerSPI_struct {
  ...
  * a non-zero value at the input SafetyProviderID of the safety Consumer's SAPI. */
  ...
  UAS_UInt32 dwSafetyStructureSignature;
  /** SafetyStructureSignatureVersion is not used in the SafetyConsumer instance */
  /** SafetyStructureIdentifier is not used in the SafetyConsumer instance */
