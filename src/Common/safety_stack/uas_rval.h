...
/** @name LED states
 *  These macros define codes for LED states.
 */
/**@{*/
#define UASRVAL_LED_OFF 0x00u      /**< The LED shall be switched OFF      */
#define UASRVAL_LED_ON 0x01u       /**< The LED shall be switched ON       */
#define UASRVAL_LED_FLASHING 0x02u /**< The LED shall be flashing          */
/**@}*/
