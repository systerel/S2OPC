 ...
 */
static void vUASRVAR_Memset(void* pbyAddress,   /**< Pointer to the block of memory */
 ...
 */
static void vUASRVAR_Memset(void* pbyAddress, UAS_UInt8 byValue, UAS_UInt32 ulLength)
{
