 ...
 */
extern void vUASTIME_Init(UASTIME_Instance_type* const pzTimerInst,   /**< Pointer to the primary instance data   */
 ...
 */
extern void vUASTIME_Stop(UASTIME_Instance_type* const pzTimerInst,   /**< Pointer to the primary instance data   */
                          UASTIME_Instance_type* const r_pzTimerInst, /**< Pointer to the redundant instance data */
                          UASTIME_Timestamp_type const dwCurrentTime  /**< current time value */
);
