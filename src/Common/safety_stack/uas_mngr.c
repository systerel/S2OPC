...
)
{
  ...
  UASDEF_LOG_DEBUG( "  byUAS_InitSafetyProvider: Entry. pzInstanceData = %p, uInstanceIndex = %04Xh", pzInstanceData, uInstanceIndex );
  ...
  if ( UAS_OK EQ byRetVal )
  {
    ...
    else
    {
      ...
      if ( UAS_OK EQ byRetVal )
      {
        byRetVal = byUASPROV_Init( &( azUAS_ProvStateMachines[uInstanceIndex] ), &( r_azUAS_ProvStateMachines[uInstanceIndex] ), pzInstanceData, pnResult );
      } /* if */
    } /* else */
  } /* if */
...
)
{
  ...
  UASDEF_LOG_DEBUG( "  byUAS_ChangeSafetyProviderSPI: Entry. uInstanceIndex = %04Xh, dwHandle = %08Xh", uInstanceIndex, dwHandle );
  ...
  if ( UAS_OK EQ byRetVal )
  {
    ...
    else
    {
      ...
      if ( ( 0uL            EQ     pzStateMachine->dwParamFcs ) OR
           ( pzInstanceData NOT_EQ pzStateMachine->pzInstanceData ) )
      {
        byRetVal = UAS_STATE_ERR;
      } /* if */
...
)
{
  ...
  UASDEF_LOG_DEBUG( "  byUAS_StartSafetyProvider: Entry. uInstanceIndex = %04Xh, dwHandle = %08Xh", uInstanceIndex, dwHandle );
...
)
{
  ...
  UASDEF_LOG_DEBUG( "  byUAS_ExecuteSafetyProvider: Entry. uInstanceIndex = %04Xh, dwHandle = %08Xh", uInstanceIndex, dwHandle );
  ...
  if ( UAS_OK EQ byRetVal )
  {
    ...
    else
    {
      ...
      if ( ( 1u EQ pzInstanceData->bAppDone ) AND
           ( 1u EQ pzInstanceData->bCommDone ) )
      {
...
UASDEF_LOG_DEBUG( "  byUAS_StopSafetyProvider: Entry. uInstanceIndex = %04Xh, dwHandle = %08Xh", uInstanceIndex, dwHandle );
...
)
{
  ...
  UASDEF_LOG_DEBUG( "  byUAS_ResetSafetyProvider: Entry. uInstanceIndex = %04Xh, dwHandle = %08Xh", uInstanceIndex, dwHandle );
...
)
{
  ...
  UASDEF_LOG_DEBUG( "  byUAS_InitSafetyConsumer: Entry. pzInstanceData = %p, uInstanceIndex = %04Xh", pzInstanceData, uInstanceIndex );
  ...
  if ( UAS_OK EQ byRetVal )
  {
    ...
    else
    {
      ...
      if ( UAS_OK EQ byRetVal )
      {
        byRetVal = byUASCONS_Init( &( azUAS_ConsStateMachines[uInstanceIndex] ), &( r_azUAS_ConsStateMachines[uInstanceIndex] ), pzInstanceData, pnResult );
      } /* if */
    } /* else */
  } /* if */
...
)
{
  ...
  UASDEF_LOG_DEBUG( "  byUAS_ChangeSafetyConsumerSPI: Entry. uInstanceIndex = %04Xh, dwHandle = %08Xh", uInstanceIndex, dwHandle );
...
)
{
  ...
  UASDEF_LOG_DEBUG( "  byUAS_ChangeSafetyConsumerTimeout: Entry. uInstanceIndex = %04Xh, dwHandle = %08Xh", uInstanceIndex, dwHandle );
...
)
{
  ...
  UASDEF_LOG_DEBUG( "  byUAS_StartSafetyConsumer: Entry. uInstanceIndex = %04Xh, dwHandle = %08Xh", uInstanceIndex, dwHandle );
...
)
{
  ...
  UASDEF_LOG_DEBUG( "  byUAS_ExecuteSafetyConsumer: Entry. uInstanceIndex = %04Xh, dwHandle = %08Xh", uInstanceIndex, dwHandle );
...
)
{
  ...
  UASDEF_LOG_DEBUG( "  byUAS_StopSafetyConsumer: Entry. uInstanceIndex = %04Xh, dwHandle = %08Xh", uInstanceIndex, dwHandle );
...
)
{
  ...
  UASDEF_LOG_DEBUG( "  byUAS_ResetSafetyConsumer: Entry. uInstanceIndex = %04Xh, dwHandle = %08Xh", uInstanceIndex, dwHandle );
...
{
  /* Timer error ocurred ? */
  if ( ( UAS_OK EQ byRetVal                                 ) AND
       ( UASRVAR_INVALID_ERROR_COUNT( wUASTIME_ErrorCount ) ) )
  {
