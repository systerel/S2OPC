...
#define UASRVAR_VALID_BOOL( var )            \
  ( ( var ) EQ (UAS_Bool)( COMPL ( r_##var ) ) )

/** Invalid redundant variables of type UAS_Bool. */
#define UASRVAR_INVALID_BOOL( var )          \
  ( ( var ) NOT_EQ (UAS_Bool)( COMPL ( r_##var ) ) )
...
#define UASRVAR_VALID_USIGN8( var )          \
  ( ( var ) EQ (UAS_UInt8)( COMPL ( r_##var ) ) )

/** Invalid redundant variables of type UAS_UInt8. */
#define UASRVAR_INVALID_USIGN8( var )        \
  ( ( var ) NOT_EQ (UAS_UInt8)( COMPL ( r_##var ) ) )
...
#define UASRVAR_VALID_USIGN16( var )         \
  ( ( var ) EQ (UAS_UInt16)( COMPL ( r_##var ) ) )

/** Invalid redundant variables of type UAS_UInt16. */
#define UASRVAR_INVALID_USIGN16( var )       \
  ( ( var ) NOT_EQ (UAS_UInt16)( COMPL ( r_##var ) ) )
...
#define UASRVAR_VALID_USIGN32( var )         \
  ( ( var ) EQ     (UAS_UInt32)( COMPL ( r_##var ) ) )

/** Invalid redundant variables of type UAS_UInt32. */
#define UASRVAR_INVALID_USIGN32( var )       \
  ( ( var ) NOT_EQ (UAS_UInt32)( COMPL ( r_##var ) ) )
...
/** Valid redundant variables of type UAS_UInt32. */
#define UASRVAR_VALID_USIGN64( var )         \
  ( ( var ) EQ     (UAS_UInt64)( COMPL ( r_##var ) ) )

/** Invalid redundant variables of type UAS_UInt64. */
#define UASRVAR_INVALID_USIGN64( var )       \
  ( ( var ) NOT_EQ (UAS_UInt64)( COMPL ( r_##var ) ) )
...
#define UASRVAR_VALID_PROVSTATE( var )      \
  ( ( var ) EQ /*lint -e(960)*/ (UASPROV_State_type)( COMPL ( r_##var ) ) )

/** Invalid redundant variables of type UASPROV_State_type. */
#define UASRVAR_INVALID_PROVSTATE( var )         \
  ( ( var ) NOT_EQ /*lint -e(960)*/ (UASPROV_State_type)( COMPL ( r_##var ) ) )
...
#define UASRVAR_VALID_CONSSTATE( var )      \
  ( ( var ) EQ /*lint -e(960)*/ (UASCONS_State_type)( COMPL ( r_##var ) ) )

/** Invalid redundant variables of type UASCONS_State_type. */
#define UASRVAR_INVALID_CONSSTATE( var )         \
  ( ( var ) NOT_EQ /*lint -e(960)*/ (UASCONS_State_type)( COMPL ( r_##var ) ) )
...
#define UASRVAR_VALID_ERROR_COUNT( err )     \
  ( ( 0u EQ ( err ) ) AND                    \
    ( ( err ) EQ ( UASRVAR_MAX_ERROR_COUNT - ( r_##err ) ) ) )

/** Invalid redundant error count. */
#define UASRVAR_INVALID_ERROR_COUNT( err )   \
  ( ( 0u < ( err ) ) OR                      \
    ( ( err ) NOT_EQ ( UASRVAR_MAX_ERROR_COUNT - ( r_##err ) ) ) )
