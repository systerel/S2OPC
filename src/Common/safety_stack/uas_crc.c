 ...
 */
#define UASCRC_CALC_CRC32(r, v) /*lint -e(960)*/ \
    (dwUASCRC_CRC32Table[(((r) >> 24) XOR(v)) BITAND 0xffu] XOR(UAS_UInt32)((r) << 8))
...
UAS_UInt32 dwUASCRC_Calculate(const UAS_ResponseSpdu_type* pzResponseSpdu, const UAS_UInt16 wSafetyDataLen)
{
