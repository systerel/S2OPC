...
SOPC_ReturnStatus SOPC_PKIProvider_CreateLeafProfile(const char* securityPolicyUri, SOPC_PKI_LeafProfile** ppProfile)
{
    ...
    {
        pProfileRef = SOPC_PKIProvider_GetLeafProfileFromSecurityPolicy(securityPolicyUri);
        if (NULL == pProfileRef)
        {
            return SOPC_STATUS_INVALID_PARAMETERS;
        }
...
SOPC_ReturnStatus SOPC_PKIProvider_CreateProfile(const char* securityPolicyUri, SOPC_PKI_Profile** ppProfile)
{
    ...
    const SOPC_PKI_ChainProfile* pChainProfileRef =
        SOPC_PKIProvider_GetChainProfileFromSecurityPolicy(securityPolicyUri);
                                                        ...
                                                        uint32_t* error)
{
    ...
    *error = SOPC_CertificateValidationError_Unknown;
    ...
    if (NULL != pProfile->sanApplicationUri)
    {
        status = SOPC_PKIProvider_CheckApplicationUri(pToValidate, pProfile->sanApplicationUri);
        if (SOPC_STATUS_OK != status)
        {
...
SOPC_ReturnStatus SOPC_PKIPermissive_Create(SOPC_PKIProvider** ppPKI)
{
    ...
    pPKI->pFnValidateCert = &SOPC_PKIProvider_ValidateAnything;
                                                       ...
                                                       SOPC_CRLList** ppIssuerCrl)
{
    ...
    status = SOPC_PKIProvider_MergeCertificates(pPKI->pTrustedRoots, pPKI->pTrustedCerts, &pTrustedCerts);
    ...
    if (SOPC_STATUS_OK == status)
    {
        status = SOPC_PKIProvider_MergeCertificates(pPKI->pIssuerRoots, pPKI->pIssuerCerts, &pIssuerCerts);
    }
                                                   ...
                                                   const bool bIncludeExistingList)
{
    ...
    {
        status = SOPC_PKIProvider_GetListLength(pPKI->pTrustedCerts, pPKI->pTrustedCrl, pPKI->pIssuerCerts,
                                                pPKI->pIssuerCrl, &PKILen);
    }
    if (SOPC_STATUS_OK == status)
    {
        status = SOPC_PKIProvider_GetListLength(pTrustedCerts, pTrustedCrl, pIssuerCerts, pIssuerCrl, &updateLen);
    }
    if (SOPC_STATUS_OK != status)
    {
        return status;
                                                  ...
                                                  const bool bIncludeExistingList)
{
    ...
    status = SOPC_PKIProvider_CheckListLength(pPKI, pTrustedCerts, pTrustedCrl, pIssuerCerts, pIssuerCrl,
                                              bIncludeExistingList);
    ...
    if (SOPC_STATUS_OK == status)
    {
        status = SOPC_PKIProvider_CheckSecurityLevelOfTheUpdate(pTrustedCerts, pTrustedCrl, pIssuerCerts, pIssuerCrl,
                                                                securityPolicyUri);
    }
    ...
    if (SOPC_STATUS_OK == status)
    {
        ...
        if (bIncludeExistingList && !pPKI->isPermissive)
        {
            ...
            status = SOPC_PKIProvider_MergeCertificates(pPKI->pTrustedCerts, pTrustedCerts, &tmp_pTrustedCertsTmp);
            if (SOPC_STATUS_OK == status)
            {
                status =
                    SOPC_PKIProvider_MergeCertificates(pPKI->pTrustedRoots, tmp_pTrustedCertsTmp, &tmp_pTrustedCerts);
            }
            /* tmp_pTrustedCrl = pTrustedCrl + pPKI->pTrustedCrl */
            if (SOPC_STATUS_OK == status)
            {
                status = SOPC_PKIProvider_MergeCRLs(pPKI->pTrustedCrl, pTrustedCrl, &tmp_pTrustedCrl);
            }
            /* tmp_pIssuerCerts = pIssuerCerts + pPKI->pIssuerCerts + pPKI->pIssuerRoot */
            if (SOPC_STATUS_OK == status)
            {
                status = SOPC_PKIProvider_MergeCertificates(pPKI->pIssuerCerts, pIssuerCerts, &tmp_pIssuerCertsTmp);
            }
            if (SOPC_STATUS_OK == status)
            {
                status = SOPC_PKIProvider_MergeCertificates(pPKI->pIssuerRoots, tmp_pIssuerCertsTmp, &tmp_pIssuerCerts);
            }
            /* tmp_pIssuerCrl = pIssuerCrl + pPKI->pIssuerCrl */
            if (SOPC_STATUS_OK == status)
            {
                status = SOPC_PKIProvider_MergeCRLs(pPKI->pIssuerCrl, pIssuerCrl, &tmp_pIssuerCrl);
            }
                                                     ...
                                                     bool* pIsIssuer)
{
    ...
    *pIsIssuer = false;
    ...
    if (bIsTrusted)
    {
        ...
        {
            status = SOPC_PKIProvider_RemoveCertByThumbprint(&pPKI->pTrustedCerts, &pPKI->pTrustedCrl, pThumbprint,
                                                             "trusted list", &bCertIsRemoved, &bCertIsCA);
        }
        if (NULL != pPKI->pTrustedRoots && SOPC_STATUS_OK == status)
        {
            status = SOPC_PKIProvider_RemoveCertByThumbprint(&pPKI->pTrustedRoots, &pPKI->pTrustedCrl, pThumbprint,
        ...
        if (NULL != pPKI->pAllTrusted && SOPC_STATUS_OK == status)
        {
            ...
            status = SOPC_PKIProvider_RemoveCertByThumbprint(&pPKI->pAllTrusted, &pPKI->pTrustedCrl, pThumbprint, NULL,
    ...
    else
    {
        ...
        {
            status = SOPC_PKIProvider_RemoveCertByThumbprint(&pPKI->pIssuerCerts, &pPKI->pIssuerCrl, pThumbprint,
        ...
        {
            status = SOPC_PKIProvider_RemoveCertByThumbprint(&pPKI->pIssuerRoots, &pPKI->pIssuerCrl, pThumbprint,
    ...
    if (SOPC_STATUS_OK == status && bIsRemoved)
    {
        ...
        {
            status = SOPC_PKIProvider_RemoveCertByThumbprint(&pPKI->pAllCerts, &pPKI->pAllCrl, pThumbprint, NULL,
                                                             &bAllCertIsRemoved, &bAllCertIsCA);
        }
        if (NULL != pPKI->pAllRoots && SOPC_STATUS_OK == status)
        {
            status = SOPC_PKIProvider_RemoveCertByThumbprint(&pPKI->pAllRoots, &pPKI->pAllCrl, pThumbprint, NULL,
    ...
    SOPC_PKIProvider** ppPKI)
{
    ...
    if (SOPC_STATUS_OK == status)
    {
        status = SOPC_PKIProvider_LoadCertificateAndCRLListFromStore(basePath, &pTrustedCerts, &pTrustedCrl,
