...
#building
west build -p -b sam_e70_xplained --build-dir /builds/systerel/S2OPC/sub ~/zephyrproject/modules/lib/s2opc/samples/PubSub_ClientServer/zephyr/pubsub_test_server -- -DPUBSUB_STATIC_CONFIG=ON
