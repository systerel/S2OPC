...
SOPC_PubSubConfiguration* SOPC_PubSubConfig_GetStatic(void)
{
    ...
    if (alloc)
    {
        ...
        // GroupVersion = 1
        // PubId = 123
        readerGroup = SOPC_PubSubConfig_SetSubMessageAt(connection, 0, SOPC_SecurityMode_None, 14, 1, 123, 2);
    ...
    if (alloc)
    {
        ...
        dsReader = SOPC_PubSubConfig_SetReaderAt(readerGroup, 0, 0, 2000.000000);
        alloc = NULL != dsReader;
    }
    ...
    if (alloc)
    {
        SOPC_PubSubConfig_SetSubVariableAt(dsReader, 0, "ns=1;s=Toto", SOPC_Boolean_Id); // SubBoolean
    }
    ...
    {
        // Interval = 2000.000000 ms
        dsReader = SOPC_PubSubConfig_SetReaderAt(readerGroup, 1, 0, 2000.000000);
        alloc = NULL != dsReader;
    }
    ...
    if (alloc)
    {
        SOPC_PubSubConfig_SetSubVariableAt(dsReader, 0, "ns=2;i=6", SOPC_UInt32_Id); // SubUInt32
        SOPC_PubSubConfig_SetSubVariableAt(dsReader, 1, "ns=2;i=7", SOPC_UInt16_Id); // SubUInt16
    }
    ...
    if (alloc)
    {
        ...
        // GroupVersion = 1
        // PubId = 123
        readerGroup = SOPC_PubSubConfig_SetSubMessageAt(connection, 1, SOPC_SecurityMode_None, 15, 1, 123, 1);
        alloc = NULL != readerGroup;
    }
    ...
    if (alloc)
    {
        SOPC_PubSubConfig_SetSubVariableAt(dsReader, 0, "ns=1;s=Tata", SOPC_Int16_Id);    // SubInt16
        SOPC_PubSubConfig_SetSubVariableAt(dsReader, 1, "ns=1;s=Chaine", SOPC_String_Id); // SubString
    }
