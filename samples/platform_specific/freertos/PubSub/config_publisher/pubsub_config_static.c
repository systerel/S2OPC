...
SOPC_PubSubConfiguration* SOPC_PubSubConfig_GetStatic(void)
{
    ...
    if (alloc)
    {
        ...
        //alloc = SOPC_PubSubConnection_Set_Address(connection, "opc.udp://192.168.1.64:4840");
    ...
    if (alloc)
    {
        ...
        assert(NULL != writer);
        // WriterId = 50
        dataset = SOPC_PubSubConfig_InitDataSet(config, 0, writer, 50, 1);
        alloc = NULL != dataset;
    }
    if (alloc)
    {
    ...
    if (alloc)
    {
        ...
        assert(NULL != writer);
        // WriterId = 51
        dataset = SOPC_PubSubConfig_InitDataSet(config, 1, writer, 51, 2);
        alloc = NULL != dataset;
    }
    if (alloc)
    {
    ...
    if (alloc)
    {
        ...
        writerGroup = SOPC_PubSubConfig_SetPubMessageAt(connection, 1, 15, 1, 1000.000000, -1, SOPC_SecurityMode_None);
        alloc = NULL != writerGroup;
    }
    ...
    if (alloc)
    {
        ...
        assert(NULL != writer);
        // WriterId = 52
        dataset = SOPC_PubSubConfig_InitDataSet(config, 2, writer, 52, 2);
        alloc = NULL != dataset;
    }
    if (alloc)
    {
        SOPC_PubSubConfig_SetPubVariableAt(dataset, 0, "ns=1;i=2", SOPC_Int16_Id);  // PubInt16
        SOPC_PubSubConfig_SetPubVariableAt(dataset, 1, "ns=1;i=8", SOPC_String_Id); // PubString
    }
