...
configuration_parameters_security = {'path_cert_auth': os.path.join(PKI_BASE_PATH, 'certs', 'cacert.der'),
                                     ...
                                     'path_cert_srv': os.path.join(CERT_BASE_PATH, 'server_public', 'server_4k_cert.der'),
                                     'path_cert_cli': os.path.join(CERT_BASE_PATH, 'client_public', 'client_4k_cert.der'),
                                     'path_key_cli': os.path.join(CERT_BASE_PATH, 'client_private', 'encrypted_client_4k_key.pem'),
