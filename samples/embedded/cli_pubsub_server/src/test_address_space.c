             ...
             {.object_type =
                  {
                      ...
                      .DisplayName = {{0, 0, NULL},
                                      {sizeof("DataTypeEncodingType") - 1, 1, (SOPC_Byte*) "DataTypeEncodingType"}},
                      .Description = {{0, 0, NULL}, {0, 0, NULL}},
                      .NoOfReferences = 1,
                      .References =
                          (const OpcUa_ReferenceNode[]){
             ...
             {.object_type =
                  {
                      ...
                      .DisplayName = {{0, 0, NULL},
                                      {sizeof("ModellingRuleType") - 1, 1, (SOPC_Byte*) "ModellingRuleType"}},
                      .Description = {{0, 0, NULL}, {0, 0, NULL}},
                      .NoOfReferences = 2,
                      .References =
                          (const OpcUa_ReferenceNode[]){
             ...
             {.object =
                  {
                      ...
                      .DisplayName = {{0, 0, NULL},
                                      {sizeof("OptionalPlaceholder") - 1, 1, (SOPC_Byte*) "OptionalPlaceholder"}},
                      .Description = {{0, 0, NULL}, {0, 0, NULL}},
                      .NoOfReferences = 2,
                      .References =
                          (const OpcUa_ReferenceNode[]){
             ...
             {.variable =
                  {
                      ...
                      .Description =
                          {{0, 0, NULL},
                           {sizeof("Specified the significances of the BrowseName when a type is instantiated.") - 1, 1,
                            (SOPC_Byte*) "Specified the significances of the BrowseName when a type is instantiated."}},
                      .NoOfReferences = 1,
                      .References =
                          (const OpcUa_ReferenceNode[]){
                              {
             ...
             {.object =
                  {
                      ...
                      .DisplayName = {{0, 0, NULL},
                                      {sizeof("MandatoryPlaceholder") - 1, 1, (SOPC_Byte*) "MandatoryPlaceholder"}},
                      .Description = {{0, 0, NULL}, {0, 0, NULL}},
                      .NoOfReferences = 2,
                      .References =
                          (const OpcUa_ReferenceNode[]){
             ...
             {.variable =
                  {
                      ...
                      .DisplayName = {{0, 0, NULL},
                                      {sizeof("MaxByteStringLength") - 1, 1, (SOPC_Byte*) "MaxByteStringLength"}},
                      .Description = {{0, 0, NULL}, {0, 0, NULL}},
                      .NoOfReferences = 1,
                      .References =
                          (const OpcUa_ReferenceNode[]){
             ...
             {.variable =
                  {
                      ...
                      .DisplayName = {{0, 0, NULL},
                                      {sizeof("MaxNodesPerWrite") - 1, 1, (SOPC_Byte*) "MaxNodesPerWrite"}},
                      .Description = {{0, 0, NULL}, {0, 0, NULL}},
                      .NoOfReferences = 1,
                      .References =
                          (const OpcUa_ReferenceNode[]){
             ...
             {.variable =
                  {
                      ...
                      .DisplayName = {{0, 0, NULL},
                                      {sizeof("MaxNodesPerBrowse") - 1, 1, (SOPC_Byte*) "MaxNodesPerBrowse"}},
                      .Description = {{0, 0, NULL}, {0, 0, NULL}},
                      .NoOfReferences = 1,
                      .References =
                          (const OpcUa_ReferenceNode[]){
             ...
             {.variable =
                  {
                      ...
                      .NodeClass = OpcUa_NodeClass_Variable,
                      .BrowseName =
                          {0, {sizeof("MaxNodesPerRegisterNodes") - 1, 1, (SOPC_Byte*) "MaxNodesPerRegisterNodes"}},
                      .DisplayName = {{0, 0, NULL},
                                      {sizeof("MaxNodesPerRegisterNodes") - 1, 1,
                                       (SOPC_Byte*) "MaxNodesPerRegisterNodes"}},
                      .Description = {{0, 0, NULL}, {0, 0, NULL}},
                      .NoOfReferences = 1,
                      .References =
                          (const OpcUa_ReferenceNode[]){
             ...
             {.variable =
                  {
                      ...
                      .NodeClass = OpcUa_NodeClass_Variable,
                      .BrowseName = {0,
                                     {sizeof("MaxNodesPerTranslateBrowsePathsToNodeIds") - 1, 1,
                                      (SOPC_Byte*) "MaxNodesPerTranslateBrowsePathsToNodeIds"}},
                      .DisplayName = {{0, 0, NULL},
                                      {sizeof("MaxNodesPerTranslateBrowsePathsToNodeIds") - 1, 1,
                                       (SOPC_Byte*) "MaxNodesPerTranslateBrowsePathsToNodeIds"}},
                      .Description = {{0, 0, NULL}, {0, 0, NULL}},
             ...
             {.variable =
                  {
                      ...
                      .NodeClass = OpcUa_NodeClass_Variable,
                      .BrowseName =
                          {0, {sizeof("MaxNodesPerNodeManagement") - 1, 1, (SOPC_Byte*) "MaxNodesPerNodeManagement"}},
                      .DisplayName = {{0, 0, NULL},
                                      {sizeof("MaxNodesPerNodeManagement") - 1, 1,
                                       (SOPC_Byte*) "MaxNodesPerNodeManagement"}},
                      .Description = {{0, 0, NULL}, {0, 0, NULL}},
                      .NoOfReferences = 1,
                      .References =
                          (const OpcUa_ReferenceNode[]){
             ...
             {.variable =
                  {
                      ...
                      .NodeClass = OpcUa_NodeClass_Variable,
                      .BrowseName =
                          {0, {sizeof("MaxMonitoredItemsPerCall") - 1, 1, (SOPC_Byte*) "MaxMonitoredItemsPerCall"}},
                      .DisplayName = {{0, 0, NULL},
                                      {sizeof("MaxMonitoredItemsPerCall") - 1, 1,
                                       (SOPC_Byte*) "MaxMonitoredItemsPerCall"}},
                      .Description = {{0, 0, NULL}, {0, 0, NULL}},
                      .NoOfReferences = 1,
                      .References =
                          (const OpcUa_ReferenceNode[]){
             ...
             {.data_type =
                  {
                      ...
                      .NodeClass = OpcUa_NodeClass_DataType,
                      .BrowseName =
                          {0, {sizeof("SignedSoftwareCertificate") - 1, 1, (SOPC_Byte*) "SignedSoftwareCertificate"}},
                      .DisplayName = {{0, 0, NULL},
                                      {sizeof("SignedSoftwareCertificate") - 1, 1,
                                       (SOPC_Byte*) "SignedSoftwareCertificate"}},
                      .Description = {{0, 0, NULL}, {0, 0, NULL}},
                      .NoOfReferences = 4,
                      .References =
                          (const OpcUa_ReferenceNode[]){
                      ...
                      .DataTypeDefinition =
                          {{{SOPC_IdentifierType_Numeric, 0, .Data.Numeric = 122}, {0, 0, NULL}, 0},
                           SOPC_ExtObjBodyEncoding_Object,
                           .Body.Object = {(OpcUa_StructureDefinition[]){
                                               ...
                                               {&OpcUa_StructureDefinition_EncodeableType,
                                                ...
                                                (OpcUa_StructureField[]){
                                                    {&OpcUa_StructureField_EncodeableType,
                                                     ...
                                                     false},
                                                    {&OpcUa_StructureField_EncodeableType,
                                                     {sizeof("ManufacturerName") - 1, 1,
                                                      (SOPC_Byte*) "ManufacturerName"},
                                                     {{0, 0, NULL}, {0, 0, NULL}},
                                                     {SOPC_IdentifierType_Numeric, 0, .Data.Numeric = 12},
                                                     -1,
                                                     0,
             ...
             {.data_type =
                  {
                      ...
                      .DataTypeDefinition = {{{SOPC_IdentifierType_Numeric, 0, .Data.Numeric = 123}, {0, 0, NULL}, 0},
                                             SOPC_ExtObjBodyEncoding_Object,
                                             .Body.Object =
                                                                                ...
                                                                                OpcUa_EnumField
                                                                                    []){{&OpcUa_EnumField_EncodeableType,
                                                                                        ...
                                                                                        {&OpcUa_EnumField_EncodeableType,
                                                                                         ...
                                                                                         {{0, 0, NULL}, {0, 0, NULL}},
                                                                                         {{0, 0, NULL}, {0, 0, NULL}},
                                                                                         {sizeof("Transparent") - 1,
                                                                                          1, (SOPC_Byte*) "Transparent"}},
                                                                                        {&OpcUa_EnumField_EncodeableType,
                                                                                         5,
                                                                                         {{0, 0, NULL}, {0, 0, NULL}},
                                                                                         {{0, 0, NULL}, {0, 0, NULL}},
                                                                                         {sizeof("HotAndMirrored") - 1,
                                                                                          1, (SOPC_Byte*) "HotAndMirrored"}}}}},
             ...
             {.data_type =
                  {
                      ...
                      .DataTypeDefinition =
                          {{{SOPC_IdentifierType_Numeric, 0, .Data.Numeric = 123}, {0, 0, NULL}, 0},
                           SOPC_ExtObjBodyEncoding_Object,
                           .Body.Object =
                               {(OpcUa_EnumDefinition[]){
                                    {&OpcUa_EnumDefinition_EncodeableType, 8,
                                     (OpcUa_EnumField[]){
                                         {&OpcUa_EnumField_EncodeableType,
                                          0,
                                          {{0, 0, NULL}, {0, 0, NULL}},
             ...
             {.data_type =
                  {
                      ...
                      .DisplayName = {{0, 0, NULL},
                                      {sizeof("ServerStatusDataType") - 1, 1, (SOPC_Byte*) "ServerStatusDataType"}},
                      .Description = {{0, 0, NULL}, {0, 0, NULL}},
                      .NoOfReferences = 4,
                      .References =
                          (const OpcUa_ReferenceNode[]){
                                               ...
                                               {&OpcUa_StructureDefinition_EncodeableType,
                                                ...
                                                (OpcUa_StructureField[]){
                                                    ...
                                                    {&OpcUa_StructureField_EncodeableType,
                                                     ...
                                                     false},
                                                    {&OpcUa_StructureField_EncodeableType,
                                                     {sizeof("SecondsTillShutdown") - 1, 1,
                                                      (SOPC_Byte*) "SecondsTillShutdown"},
                                                     {{0, 0, NULL}, {0, 0, NULL}},
...
SOPC_Variant SOPC_Embedded_VariableVariant[55] = {
    ...
    {true,
     ...
     {.Array = {1,
                {.StringArr = (SOPC_String[]){{sizeof("https://www.systerel.fr/S2OPC/demo/data/origin") - 1, 1,
                                               (SOPC_Byte*) "https://www.systerel.fr/S2OPC/demo/data/origin"}}}}}},

    {true,
     SOPC_String_Id,
     SOPC_VariantArrayType_Array,
     {.Array = {2,
                {.StringArr = (SOPC_String[]){{sizeof("http://opcfoundation.org/UA/") - 1, 1,
                                               (SOPC_Byte*) "http://opcfoundation.org/UA/"},
                                              {sizeof("https://www.systerel.fr/S2OPC/demo/data/origin") - 1, 1,
                                               (SOPC_Byte*) "https://www.systerel.fr/S2OPC/demo/data/origin"}}}}}},
    ...
    {true,
     ...
     {.Array = {6,
                {.LocalizedTextArr =
                     (SOPC_LocalizedText[]){
                         {{0, 0, NULL}, {sizeof("None") - 1, 1, (SOPC_Byte*) "None"}},
                         {{0, 0, NULL}, {sizeof("Cold") - 1, 1, (SOPC_Byte*) "Cold"}},
                         {{0, 0, NULL}, {sizeof("Warm") - 1, 1, (SOPC_Byte*) "Warm"}},
                         {{0, 0, NULL}, {sizeof("Hot") - 1, 1, (SOPC_Byte*) "Hot"}},
                         {{0, 0, NULL}, {sizeof("Transparent") - 1, 1, (SOPC_Byte*) "Transparent"}},
                         {{0, 0, NULL}, {sizeof("HotAndMirrored") - 1, 1, (SOPC_Byte*) "HotAndMirrored"}}}}}}},
    ...
    {true,
     ...
     {.Array = {8,
                {.LocalizedTextArr =
                     (SOPC_LocalizedText[]){
                         {{0, 0, NULL}, {sizeof("Running") - 1, 1, (SOPC_Byte*) "Running"}},
                         {{0, 0, NULL}, {sizeof("Failed") - 1, 1, (SOPC_Byte*) "Failed"}},
                         {{0, 0, NULL}, {sizeof("NoConfiguration") - 1, 1, (SOPC_Byte*) "NoConfiguration"}},
                         {{0, 0, NULL}, {sizeof("Suspended") - 1, 1, (SOPC_Byte*) "Suspended"}},
                         {{0, 0, NULL}, {sizeof("Shutdown") - 1, 1, (SOPC_Byte*) "Shutdown"}},
                         {{0, 0, NULL}, {sizeof("Test") - 1, 1, (SOPC_Byte*) "Test"}},
                         {{0, 0, NULL}, {sizeof("CommunicationFault") - 1, 1, (SOPC_Byte*) "CommunicationFault"}},
                         {{0, 0, NULL}, {sizeof("Unknown") - 1, 1, (SOPC_Byte*) "Unknown"}}}}}}},
