...
Script use example:
saxonb-xslt -s:$S2OPC_REPO/tests/data/address_space/s2opc_origin.xml -xsl:$S2OPC_REPO/scripts/gen-reciprocal-refs-address-space.xslt -o:$S2OPC_REPO/tests/data/address_space/s2opc.xml -->
