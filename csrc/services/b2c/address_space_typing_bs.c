...
static const SOPC_NodeId* get_direct_parent(const SOPC_NodeId* childNodeId)
{
    ...
    else if (SOPC_HAS_SUBTYPE_HYBRID_RESOLUTION)
    {
        ...
        node = SOPC_Dict_Get(SOPC_AddressSpace_Get_Items(address_space_bs__nodes), childNodeId, &node_found);
                                                       ...
                                                       t_bool* const address_space_typing_bs__bres)
{
    ...
    *address_space_typing_bs__bres = false;
    ...
    else if (SOPC_HAS_SUBTYPE_HYBRID_RESOLUTION)
    {
        ...
        bool node_found = false;
        SOPC_AddressSpace_Item* node =
            SOPC_Dict_Get(SOPC_AddressSpace_Get_Items(address_space_bs__nodes), nodeId, &node_found);
