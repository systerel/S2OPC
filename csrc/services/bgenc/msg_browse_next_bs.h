...
/******************************************************************************
 ...
 File Name            : msg_browse_next_bs.h

 Date                 : 12/11/2019 08:49:24

 C Translator Version : tradc Java V1.0 (14/03/2012)

******************************************************************************/

#ifndef _msg_browse_next_bs_h
#define _msg_browse_next_bs_h
...
/*------------------------
  ...
  ------------------------*/
extern void msg_browse_next_bs__INITIALISATION(void);

/*--------------------
   OPERATIONS Clause
  --------------------*/
extern void msg_browse_next_bs__alloc_browse_next_response(
...
extern void msg_browse_next_bs__get_browse_next_request_params(
...
extern void msg_browse_next_bs__getall_ContinuationPoint(
   const constants__t_msg_i msg_browse_next_bs__p_req_msg,
...
extern void msg_browse_next_bs__set_ResponseBrowseNext_BrowseResult(
   const constants__t_msg_i msg_browse_next_bs__p_resp_msg,
...
extern void msg_browse_next_bs__set_ResponseBrowseNext_BrowseStatus(
   const constants__t_msg_i msg_browse_next_bs__p_resp_msg,
   const constants__t_BrowseValue_i msg_browse_next_bs__p_bvi,
   const constants_statuscodes_bs__t_StatusCode_i msg_browse_next_bs__p_sc);
extern void msg_browse_next_bs__set_ResponseBrowseNext_ContinuationPoint(
   const constants__t_msg_i msg_browse_next_bs__p_resp_msg,
   const constants__t_BrowseValue_i msg_browse_next_bs__p_bvi,
