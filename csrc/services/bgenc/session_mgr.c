...
{
    {
        ...
        session_core__init_iter_orphaned_t_session(session_mgr__channel_config_idx, &session_mgr__l_continue);
        while (session_mgr__l_continue == true)
        {
            session_core__continue_iter_orphaned_t_session(&session_mgr__l_session, &session_mgr__l_continue);
                ...
                if (session_mgr__l_session_state == constants__e_session_creating)
                {
                    ...
                    if (session_mgr__l_session_channel == session_mgr__channel)
                    {
                        ...
                        if (session_mgr__l_session_state == constants__e_session_created)
                        {
                            ...
                            {
                                session_async_bs__client_gen_activate_user_session_internal_event(
...
{
    {
        ...
        if (session_mgr__l_valid_session == true)
        {
            session_async_bs__add_session_to_create(session_mgr__l_session, session_mgr__channel_config_idx,
                                                    session_mgr__bres);
            if (*session_mgr__bres == true)
            {
                session_async_bs__add_session_to_activate(session_mgr__l_session, session_mgr__user, session_mgr__bres);
            }
            if (*session_mgr__bres == false)
            {
