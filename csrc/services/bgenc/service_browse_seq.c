...
{
    {
        ...
        if (service_browse_seq__l_isvalid == true)
        {
            ...
            {
                service_browse__getall_SourceNode_NbRef(service_browse_seq__l_SrcNodeId, &service_browse_seq__l_isvalid,
                ...
                if (service_browse_seq__l_isvalid == true)
                {
                    ...
                    if (service_browse_seq__l_isvalid == true)
                    {
                        service_browse__set_ResponseBrowse_BrowseStatus(service_browse_seq__p_bvi, constants__e_sc_ok);
