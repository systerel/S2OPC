...
extern void session_core_1_bs__client_activate_session_resp_check(
   ...
   t_bool * const session_core_1_bs__valid);
extern void session_core_1_bs__client_close_session_req_msg(
   const constants__t_msg_i session_core_1_bs__req_msg);
extern void session_core_1_bs__client_close_session_resp_msg(
...
extern void session_core_1_bs__server_activate_session_check_crypto(
   ...
   t_bool * const session_core_1_bs__valid);
extern void session_core_1_bs__server_close_session_check_req(
   const constants__t_msg_i session_core_1_bs__req_msg,
   const constants__t_msg_i session_core_1_bs__resp_msg);
...
extern void session_core_1_bs__server_is_valid_session_token(
   const constants__t_session_token_i session_core_1_bs__token,
   t_bool * const session_core_1_bs__ret);
extern void session_core_1_bs__session_do_nothing(
   const constants__t_session_i session_core_1_bs__session);
