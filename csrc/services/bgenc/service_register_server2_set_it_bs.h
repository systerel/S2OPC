...
#ifndef _service_register_server2_set_it_bs_h
#define _service_register_server2_set_it_bs_h
...
/*------------------------
  ...
  ------------------------*/
extern void service_register_server2_set_it_bs__INITIALISATION(void);

/*--------------------
   OPERATIONS Clause
  --------------------*/
extern void service_register_server2_set_it_bs__add_to_registered_server2_set(
...
extern void service_register_server2_set_it_bs__clear_iter_registered_server2_set(void);
...
extern void service_register_server2_set_it_bs__get_registered_server2_recordId(
   const constants__t_RegisteredServer2Info_i service_register_server2_set_it_bs__p_registeredServerInfo,
   t_entier4 * const service_register_server2_set_it_bs__p_recordId);
extern void service_register_server2_set_it_bs__get_registered_server2_registered_server(
   const constants__t_RegisteredServer2Info_i service_register_server2_set_it_bs__p_registeredServerInfo,
   constants__t_RegisteredServer_i * const service_register_server2_set_it_bs__p_registered_server);
extern void service_register_server2_set_it_bs__init_iter_registered_server2_set(
   t_bool * const service_register_server2_set_it_bs__continue);
extern void service_register_server2_set_it_bs__remove_from_registered_server2_set(
   const t_entier4 service_register_server2_set_it_bs__p_recordId);
extern void service_register_server2_set_it_bs__reset_registered_server2_set(void);
extern void service_register_server2_set_it_bs__service_register_server2_set_it_bs_UNINITIALISATION(void);
