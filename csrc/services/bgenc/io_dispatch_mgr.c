        ...
        if ((io_dispatch_mgr__l_valid_msg == true) && (io_dispatch_mgr__l_valid_channel_config == true))
        {
            ...
            else
            {
                service_mgr__client_discovery_service_request(
                    io_dispatch_mgr__l_channel, io_dispatch_mgr__req_msg, io_dispatch_mgr__app_context,
                    io_dispatch_mgr__ret, &io_dispatch_mgr__l_buffer_out, &io_dispatch_mgr__l_req_handle);
                if (*io_dispatch_mgr__ret == constants__e_sc_ok)
                {
                    service_mgr__client_req_handle_to_request_id(io_dispatch_mgr__l_req_handle,
                                                                 &io_dispatch_mgr__l_req_handle_in_req_id);
...
{
    {
        ...
        *io_dispatch_mgr__ret = constants__e_sc_bad_invalid_argument;
        service_mgr__is_valid_app_msg_in(io_dispatch_mgr__req_msg, &io_dispatch_mgr__l_valid_msg,
        ...
        if ((io_dispatch_mgr__l_valid_msg == true) && (io_dispatch_mgr__l_valid_endpoint_config == true))
        {
            io_dispatch_mgr__get_msg_service_class(io_dispatch_mgr__l_msg_typ, &io_dispatch_mgr__l_msg_service_class);
            service_mgr__server_receive_local_service_req(
                io_dispatch_mgr__endpoint_config_idx, io_dispatch_mgr__l_msg_service_class, io_dispatch_mgr__l_msg_typ,
                io_dispatch_mgr__req_msg, io_dispatch_mgr__app_context, io_dispatch_mgr__ret);
        }
    }
}
