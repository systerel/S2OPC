...
/*--------------------
   OPERATIONS Clause
  --------------------*/
void channel_mgr_1__is_connected_channel(const constants__t_channel_i channel_mgr_1__channel,
                                         t_bool* const channel_mgr_1__bres)
{
    *channel_mgr_1__bres = channel_mgr_1__s_channel_connected_i[channel_mgr_1__channel];
}

void channel_mgr_1__is_disconnecting_channel(const constants__t_channel_config_idx_i channel_mgr_1__config_idx,
                                             t_bool* const channel_mgr_1__bres)
{
    *channel_mgr_1__bres = channel_mgr_1__s_cli_channel_disconnecting_i[channel_mgr_1__config_idx];
}

void channel_mgr_1__get_connected_channel(const constants__t_channel_config_idx_i channel_mgr_1__config_idx,
...
{
    {
        ...
        *channel_mgr_1__channel = channel_mgr_1__a_config_inv_i[channel_mgr_1__config_idx];
        constants__is_t_channel(*channel_mgr_1__channel, &channel_mgr_1__l_res);
...
void channel_mgr_1__get_channel_info(const constants__t_channel_i channel_mgr_1__channel,
...
{
    {
        ...
        *channel_mgr_1__config_idx = channel_mgr_1__a_config_i[channel_mgr_1__channel];
        constants__is_t_channel_config_idx(*channel_mgr_1__config_idx, &channel_mgr_1__l_res);
        if (channel_mgr_1__l_res == false)
        {
...
void channel_mgr_1__is_client_channel(const constants__t_channel_i channel_mgr_1__channel,
                                      t_bool* const channel_mgr_1__bres)
{
    {
        ...
        constants__is_t_endpoint_config_idx(channel_mgr_1__l_endpoint, &channel_mgr_1__l_bres);
...
{
    {
        ...
        *channel_mgr_1__endpoint_config_idx = channel_mgr_1__a_endpoint_i[channel_mgr_1__channel];
        constants__is_t_endpoint_config_idx(*channel_mgr_1__endpoint_config_idx, &channel_mgr_1__l_res);
        if (channel_mgr_1__l_res == false)
        {
...
void channel_mgr_1__getall_config_inv(const constants__t_channel_config_idx_i channel_mgr_1__p_config_idx,
                                      ...
                                      constants__t_channel_i* const channel_mgr_1__p_channel)
{
    *channel_mgr_1__p_channel = channel_mgr_1__a_config_inv_i[channel_mgr_1__p_config_idx];
    constants__is_t_channel(*channel_mgr_1__p_channel, channel_mgr_1__p_dom);
...
{
    {
        ...
        if (channel_mgr_1__l_res == false)
        {
            ...
            channel_mgr_1__card_cli_channel_connecting_i = channel_mgr_1__card_cli_channel_connecting_i + 1;
        }
    }
}

void channel_mgr_1__is_channel_connected(const constants__t_channel_i channel_mgr_1__p_channel,
                                         t_bool* const channel_mgr_1__p_con)
{
    *channel_mgr_1__p_con = channel_mgr_1__s_channel_connected_i[channel_mgr_1__p_channel];
}

void channel_mgr_1__add_channel_connected(const constants__t_channel_i channel_mgr_1__p_channel)
{
    {
        t_bool channel_mgr_1__l_res;
        ...
        if (channel_mgr_1__l_res == false)
        {
            ...
            channel_mgr_1__card_channel_connected_i = channel_mgr_1__card_channel_connected_i + 1;
        }
    }
}

void channel_mgr_1__set_config(const constants__t_channel_i channel_mgr_1__p_channel,
...
void channel_mgr_1__set_endpoint(const constants__t_channel_i channel_mgr_1__p_channel,
...
void channel_mgr_1__getall_channel_connected(const constants__t_channel_i channel_mgr_1__p_channel,
                                             t_bool* const channel_mgr_1__p_dom,
                                             constants__t_channel_config_idx_i* const channel_mgr_1__p_config_idx)
{
    *channel_mgr_1__p_config_idx = channel_mgr_1__a_config_i[channel_mgr_1__p_channel];
    constants__is_t_channel_config_idx(*channel_mgr_1__p_config_idx, channel_mgr_1__p_dom);
    if (*channel_mgr_1__p_dom == false)
    {
...
void channel_mgr_1__is_cli_channel_connecting(const constants__t_channel_config_idx_i channel_mgr_1__p_config_idx,
