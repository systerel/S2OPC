...
{
    {
        ...
        channel_mgr_1__getall_channel_connected(channel_mgr__p_channel, &channel_mgr__l_res,
                                                &channel_mgr__l_channel_conf);
        if (channel_mgr__l_res == true)
        {
            channel_mgr_1__is_client_channel(channel_mgr__p_channel, &channel_mgr__l_is_client_channel);
...
{
    {
        ...
        if (channel_mgr__all_channel_closing == true)
        {
            ...
            while ((channel_mgr__l_continue == true) && (channel_mgr__l_con == false))
            {
                channel_mgr_it__continue_iter_channel(&channel_mgr__l_continue, &channel_mgr__l_channel);
                channel_mgr_1__is_channel_connected(channel_mgr__l_channel, &channel_mgr__l_con);
            }
...
{
    {
        ...
        t_entier4 channel_mgr__l_card_channel_minus_1;
        ...
        *channel_mgr__l_allowed_new_sc = false;
        ...
        channel_mgr__l_card_channel_minus_1 = channel_mgr__l_card_channel - 1;
        if (channel_mgr__l_card_used != channel_mgr__l_card_channel)
        {
            if ((channel_mgr__l_card_used != channel_mgr__l_card_channel_minus_1) ||
...
{
    {
        ...
        channel_mgr_1__is_cli_channel_connecting(channel_mgr__config_idx, &channel_mgr__l_already_connecting);
        ...
        {
            channel_mgr_1__getall_config_inv(channel_mgr__config_idx, &channel_mgr__l_dom, &channel_mgr__l_channel);
...
{
    {
        ...
        channel_mgr_1__is_channel_connected(channel_mgr__channel, &channel_mgr__l_con);
        channel_mgr_1__getall_config_inv(channel_mgr__channel_config_idx, &channel_mgr__l_dom, &channel_mgr__l_channel);
        channel_mgr__l_is_new_sc_connection_allowed(channel_mgr__is_one_sc_auto_closing,
                                                    &channel_mgr__l_allowed_new_sc);
        if (((channel_mgr__l_con == false) && (channel_mgr__l_dom == false)) && (channel_mgr__l_allowed_new_sc == true))
        {
            time_reference_bs__get_current_TimerReference(&channel_mgr__l_current_time);
            channel_mgr_1__add_channel_connected(channel_mgr__channel, channel_mgr__l_current_time);
            channel_mgr_1__set_config(channel_mgr__channel, channel_mgr__channel_config_idx);
            channel_mgr_1__set_endpoint(channel_mgr__channel, channel_mgr__endpoint_config_idx);
...
void channel_mgr__close_all_channel(t_bool* const channel_mgr__bres)
{
    {
        t_bool channel_mgr__l_continue;
        constants__t_channel_i channel_mgr__l_channel;
...
{
    {
        ...
        channel_mgr_1__getall_channel_connected(channel_mgr__channel, &channel_mgr__l_res,
                                                &channel_mgr__l_channel_conf);
        if (channel_mgr__l_res == true)
        {
...
{
    {
        ...
        channel_mgr_1__is_cli_channel_connecting(channel_mgr__config_idx, &channel_mgr__l_is_channel_connecting);
        channel_mgr_1__is_channel_connected(channel_mgr__channel, &channel_mgr__l_is_channel_connected);
        if ((channel_mgr__l_is_channel_connecting == true) && (channel_mgr__l_is_channel_connected == false))
        {
            channel_mgr_1__remove_cli_channel_connecting(channel_mgr__config_idx);
            time_reference_bs__get_current_TimerReference(&channel_mgr__l_current_time);
            channel_mgr_1__add_channel_connected(channel_mgr__channel, channel_mgr__l_current_time);
            channel_mgr_1__set_config(channel_mgr__channel, channel_mgr__config_idx);
            channel_mgr_bs__define_SecurityPolicy(channel_mgr__channel);
            *channel_mgr__bres = true;
        }
        else
...
{
    {
        ...
        channel_mgr_1__is_cli_channel_connecting(channel_mgr__config_idx, &channel_mgr__l_res);
        if (channel_mgr__l_res == true)
        {
            channel_mgr_1__remove_cli_channel_connecting(channel_mgr__config_idx);
            *channel_mgr__bres = true;
...
{
    {
        t_entier4 channel_mgr__l_card_used;
        t_entier4 channel_mgr__l_card_channel;
        t_entier4 channel_mgr__l_card_limit;

        *channel_mgr__p_auto_closed_active = false;
        channel_mgr_1__get_card_channel_used(&channel_mgr__l_card_used);
        constants__get_card_t_channel(&channel_mgr__l_card_channel);
        channel_mgr__l_card_limit = (3 * channel_mgr__l_card_channel) / 4;
        *channel_mgr__p_auto_closed_active = (channel_mgr__l_card_used > channel_mgr__l_card_limit);
    }
}
