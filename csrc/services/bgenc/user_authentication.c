...
void user_authentication__allocate_user_if_authenticated(
   ...
   constants__t_user_i * const user_authentication__p_user) {
   {
      ...
      if (user_authentication__p_sc_valid_user == constants__e_sc_ok) {
         ...
         if (user_authentication__l_is_user_allocated == true) {
            ...
            *user_authentication__p_sc_allocated_valid_user = constants__e_sc_bad_out_of_memory;
         }
      }
      else {
         *user_authentication__p_sc_allocated_valid_user = user_authentication__p_sc_valid_user;
...
void user_authentication__allocate_valid_and_authenticated_user(
   ...
   constants__t_user_i * const user_authentication__p_user) {
   {
      ...
      constants__t_StatusCode_i user_authentication__l_sc_user_authentication;
      ...
      if (user_authentication__l_is_supported_user_token_type == true) {
         if (user_authentication__l_user_token_type != constants__e_userTokenType_anonymous) {
            ...
            user_authentication__l_sc_user_authentication = constants__e_sc_ok;
         }
         ...
         *user_authentication__p_user = constants__c_user_indet;
         if (user_authentication__l_user_token_type == constants__c_userTokenType_indet) {
            *user_authentication__p_sc_valid_user = constants__e_sc_bad_identity_token_invalid;
         }
         else {
            *user_authentication__p_sc_valid_user = constants__e_sc_bad_identity_token_rejected;
         }
      }
   }
}
