...
{
    {
        ...
        {
        case constants__e_msg_attribute_read_req:
            service_mgr__treat_read_request(service_mgr__req_msg, service_mgr__resp_msg, &service_mgr__l_bret);
            if (service_mgr__l_bret == true)
            {
                *service_mgr__StatusCode_service = constants__e_sc_ok;
            }
            else
            {
                *service_mgr__StatusCode_service = constants__e_sc_bad_unexpected_error;
            }
            break;
        case constants__e_msg_attribute_write_req:
