...
void service_mgr__treat_session_service_req(const constants__t_msg_type_i service_mgr__req_typ,
...
{
    {
        ...
        {
        case constants__e_msg_attribute_read_req:
            service_mgr__treat_read_request(service_mgr__req_msg, service_mgr__resp_msg,
                                            service_mgr__StatusCode_service);
            break;
        case constants__e_msg_attribute_write_req:
            service_mgr__treat_write_request(service_mgr__req_msg, service_mgr__StatusCode_service);
            address_space__write_WriteResponse_msg_out(service_mgr__resp_msg);
            address_space__dealloc_write_request_responses();
            break;
        case constants__e_msg_view_browse_req:
            service_browse_seq__decode_browse_request(service_mgr__req_msg, service_mgr__StatusCode_service);
            if (*service_mgr__StatusCode_service == constants__e_sc_ok)
            {
                service_browse_seq__treat_browse_request_BrowseValues(service_mgr__StatusCode_service);
                if (*service_mgr__StatusCode_service == constants__e_sc_ok)
                {
                    service_browse_seq__write_BrowseResponse_msg_out(service_mgr__resp_msg, &service_mgr__l_bret);
                    if (service_mgr__l_bret != true)
                    {
                        *service_mgr__StatusCode_service = constants__e_sc_bad_out_of_memory;
                    }
            ...
            break;
        default:
            *service_mgr__StatusCode_service = constants__e_sc_bad_service_unsupported;
            break;
        }
    }
}
...
{
    {
        ...
        case constants__e_msg_discovery_get_endpoints_req:
            service_get_endpoints_bs__treat_get_endpoints_request(
                service_mgr__req_msg, service_mgr__resp_msg, service_mgr__endpoint_config_idx, &service_mgr__l_ret);
...
{
    {
        ...
        service_mgr__l_req_handle = constants__c_request_handle_indet;
        ...
        {
            message_out_bs__get_msg_out_type(service_mgr__req_msg, &service_mgr__l_req_typ);
            ...
            case constants__e_msg_discovery_register_server2_req:
                ...
                request_handle_bs__client_fresh_req_handle(service_mgr__l_req_typ, service_mgr__l_resp_typ, true,
                                                           service_mgr__app_context, &service_mgr__l_req_handle);
                ...
                {
                    request_handle_bs__set_req_handle_channel(service_mgr__l_req_handle, service_mgr__channel);
                    ...
                    {
                        *service_mgr__ret = constants__e_sc_ok;
                    }
                }
                else
                {
...
{
    {
        ...
        if (service_mgr__l_valid_resp_header == true)
        {
            ...
            request_handle_bs__client_validate_response_request_handle(
                service_mgr__channel, service_mgr__l_request_handle, service_mgr__resp_typ,
...
{
    {
        ...
        t_bool service_mgr__l_valid_resp_header;
        constants__t_StatusCode_i service_mgr__l_ret;
        constants__t_StatusCode_i service_mgr__l_ret2;
        ...
        if (service_mgr__l_valid_req_header == true)
        {
            ...
            if (service_mgr__l_valid_req_handle == true)
            {
                ...
                session_mgr__server_validate_session_service_req(
                    ...
                    &service_mgr__l_is_valid_req, &service_mgr__l_session, &service_mgr__l_ret);
                if (service_mgr__l_is_valid_req == true)
                {
                    ...
                    if (service_mgr__l_valid_req == true)
                    {
                        ...
                        if ((service_mgr__l_valid_msg == true) && (service_mgr__l_valid_resp_header == true))
                        {
                            service_mgr__treat_session_service_req(service_mgr__req_typ, service_mgr__l_req_msg,
                                                                   service_mgr__l_resp_msg, &service_mgr__l_ret);
                            session_mgr__server_validate_session_service_resp(
                                ...
                                &service_mgr__l_is_valid_resp, &service_mgr__l_ret2);
                            if (service_mgr__l_ret2 != constants__e_sc_ok)
                            {
                    ...
                    {
                        service_mgr__l_ret = constants__e_sc_bad_decoding_error;
                    }
                }
                if (service_mgr__l_resp_msg_allocated == false)
                {
                    message_out_bs__alloc_resp_msg(constants__e_msg_service_fault_resp, &service_mgr__l_resp_msg_header,
                                                   &service_mgr__l_resp_msg);
                    message_out_bs__is_valid_msg_out(service_mgr__l_resp_msg, &service_mgr__l_valid_msg);
                    message_out_bs__is_valid_msg_out_header(service_mgr__l_resp_msg_header,
                                                            &service_mgr__l_valid_resp_header);
        ...
        if (service_mgr__l_valid_resp_header == true)
        {
            ...
            if (service_mgr__l_validated_req_handle == true)
            {
                ...
                if (service_mgr__l_is_valid_session_resp == true)
                {
                    ...
                    if ((service_mgr__l_valid_resp_msg == true) && (service_mgr__l_is_applicative_response == true))
                    {
                        message_in_bs__copy_msg_resp_header_into_msg(service_mgr__l_resp_msg_header,
                                                                     service_mgr__l_resp_msg);
                        service_response_cb_bs__cli_service_response(service_mgr__l_session, service_mgr__l_resp_msg,
                                                                     service_mgr__l_user_app_context);
                        message_in_bs__forget_resp_msg_in(service_mgr__l_resp_msg_header, service_mgr__l_resp_msg);
                    }
                    else
                    {
                        message_in_bs__dealloc_msg_in_header(service_mgr__l_resp_msg_header);
                ...
                if (service_mgr__l_valid_req == true)
                {
                    ...
                    if ((service_mgr__l_valid_msg == true) && (service_mgr__l_valid_resp_header == true))
                    {
                        ...
                        service_mgr__treat_discovery_service_req(service_mgr__l_endpoint_config_idx,
                                                                 service_mgr__req_typ, service_mgr__l_req_msg,
                                                                 service_mgr__l_resp_msg, &service_mgr__l_ret);
                        message_out_bs__write_msg_resp_header_service_status(service_mgr__l_resp_msg_header,
                                                                             service_mgr__l_ret);
                        if (service_mgr__l_ret != constants__e_sc_ok)
        ...
        if (service_mgr__l_valid_resp_header == true)
        {
            ...
            if (service_mgr__l_validated_req_handle == true)
            {
                ...
                if ((service_mgr__l_valid_resp_msg == true) && (service_mgr__l_is_applicative_response == true))
                {
                    message_in_bs__copy_msg_resp_header_into_msg(service_mgr__l_resp_msg_header,
                                                                 service_mgr__l_resp_msg);
                    service_response_cb_bs__cli_service_response(constants__c_session_indet, service_mgr__l_resp_msg,
                                                                 service_mgr__l_user_app_context);
                    message_in_bs__forget_resp_msg_in(service_mgr__l_resp_msg_header, service_mgr__l_resp_msg);
                }
                else
...
{
    {
        ...
        case constants__e_msg_discovery_service_class:
            ...
            message_out_bs__alloc_resp_msg(service_mgr__l_resp_msg_typ, &service_mgr__l_resp_msg_header,
                                           &service_mgr__l_resp_msg);
            message_out_bs__is_valid_msg_out(service_mgr__l_resp_msg, &service_mgr__l_valid_msg);
            message_out_bs__is_valid_msg_out_header(service_mgr__l_resp_msg_header, &service_mgr__l_valid_resp_header);
            break;
        default:
            message_out_bs__alloc_resp_msg(constants__e_msg_service_fault_resp, &service_mgr__l_resp_msg_header,
                                           &service_mgr__l_resp_msg);
        ...
        if ((service_mgr__l_valid_msg == true) && (service_mgr__l_valid_resp_header == true))
        {
            *service_mgr__ret = constants__e_sc_ok;
            ...
            {
            case constants__e_msg_session_service_class:
                service_mgr__treat_session_service_req(service_mgr__req_typ, service_mgr__req_msg,
                                                       service_mgr__l_resp_msg, &service_mgr__l_ret);
                break;
            case constants__e_msg_discovery_service_class:
                service_mgr__treat_discovery_service_req(service_mgr__endpoint_config_idx, service_mgr__req_typ,
                                                         service_mgr__req_msg, service_mgr__l_resp_msg,
                                                         &service_mgr__l_ret);
                break;
            default:
                service_mgr__l_ret = constants__e_sc_bad_service_unsupported;
            ...
            message_out_bs__write_msg_resp_header_service_status(service_mgr__l_resp_msg_header, service_mgr__l_ret);
            message_out_bs__copy_msg_resp_header_into_msg_out(service_mgr__l_resp_msg_header, service_mgr__l_resp_msg);
            service_response_cb_bs__srv_service_response(service_mgr__endpoint_config_idx, service_mgr__l_resp_msg,
                                                         service_mgr__app_context);
            message_out_bs__forget_resp_msg_out(service_mgr__l_resp_msg_header, service_mgr__l_resp_msg);
...
{
    {
        ...
        if ((service_mgr__l_valid_msg_header == true) && (service_mgr__l_valid_msg == true))
        {
            request_handle_bs__client_fresh_req_handle(constants__e_msg_session_create_req,
                                                       constants__e_msg_session_create_resp, false,
                                                       constants__c_no_application_context, &service_mgr__l_req_handle);
            request_handle_bs__is_valid_req_handle(service_mgr__l_req_handle, &service_mgr__l_valid_req_handle);
            if (service_mgr__l_valid_req_handle == true)
            {
                request_handle_bs__set_req_handle_channel(service_mgr__l_req_handle, service_mgr__channel);
...
{
    {
        ...
        if ((service_mgr__l_valid_msg == true) && (service_mgr__l_valid_msg_header == true))
        {
            request_handle_bs__client_fresh_req_handle(constants__e_msg_session_activate_req,
                                                       constants__e_msg_session_activate_resp, false,
                                                       constants__c_no_application_context, &service_mgr__l_req_handle);
            request_handle_bs__is_valid_req_handle(service_mgr__l_req_handle, &service_mgr__l_valid_req_handle);
            if (service_mgr__l_valid_req_handle == true)
            {
...
{
    {
        ...
        if ((service_mgr__l_valid_msg == true) && (service_mgr__l_valid_msg_header == true))
        {
            ...
            if (service_mgr__l_valid_req_handle == true)
            {
                ...
                if (service_mgr__l_ret == constants__e_sc_ok)
                {
                    request_handle_bs__set_req_handle_channel(service_mgr__l_req_handle, service_mgr__l_channel);
                    message_out_bs__write_msg_out_header_req_handle(service_mgr__l_msg_header,
                                                                    service_mgr__l_req_handle);
                    message_out_bs__write_msg_out_header_session_token(service_mgr__l_msg_header,
                                                                       service_mgr__l_session_token);
...
{
    {
        ...
        if ((service_mgr__l_valid_msg == true) && (service_mgr__l_valid_msg_header == true))
        {
            request_handle_bs__client_fresh_req_handle(constants__e_msg_session_close_req,
                                                       constants__e_msg_session_close_resp, false,
                                                       constants__c_no_application_context, &service_mgr__l_req_handle);
            request_handle_bs__is_valid_req_handle(service_mgr__l_req_handle, &service_mgr__l_valid_req_handle);
            if (service_mgr__l_valid_req_handle == true)
            {
...
{
    {
        ...
        if (service_mgr__l_valid_msg == true)
        {
            ...
            case constants__e_msg_discovery_register_server_req:
            case constants__e_msg_discovery_register_server2_req:
                service_mgr__local_client_discovery_service_request(service_mgr__l_channel, service_mgr__req_msg,
                                                                    service_mgr__app_context, service_mgr__ret,
                                                                    &service_mgr__l_buffer, &service_mgr__l_req_handle);
                message_out_bs__is_valid_buffer_out(service_mgr__l_buffer, &service_mgr__l_valid_buffer);
                if (service_mgr__l_valid_buffer == false)
                {
                    *service_mgr__ret = constants__e_sc_bad_encoding_error;
...
void service_mgr__client_discovery_service_request(const constants__t_channel_i service_mgr__channel,
                                                   ...
                                                   constants__t_request_handle_i* const service_mgr__req_handle)
{
    service_mgr__local_client_discovery_service_request(service_mgr__channel, service_mgr__req_msg,
                                                        service_mgr__app_context, service_mgr__ret,
                                                        service_mgr__buffer_out, service_mgr__req_handle);
}
...
{
    {
        ...
        request_handle_bs__is_valid_req_handle(service_mgr__request_handle, &service_mgr__l_valid_req_handle);
        if (service_mgr__l_valid_req_handle == true)
        {
            request_handle_bs__get_req_handle_resp_typ(service_mgr__request_handle, &service_mgr__l_exp_resp_msg_typ);
            ...
            case constants__e_msg_session_cancel_resp:
                session_mgr__client_validate_session_service_resp(service_mgr__channel, service_mgr__request_handle,
                                                                  &service_mgr__l_bres, &service_mgr__l_session);
                ...
                break;
            default:
                request_handle_bs__get_req_handle_app_context(
                    service_mgr__request_handle, &service_mgr__l_is_applicative, &service_mgr__l_app_context);
                request_handle_bs__get_req_handle_req_typ(service_mgr__request_handle, &service_mgr__l_req_typ);
                request_handle_bs__client_remove_req_handle(service_mgr__request_handle);
                if (service_mgr__l_is_applicative == true)
                {
                    service_response_cb_bs__cli_snd_failure(service_mgr__l_req_typ, service_mgr__l_app_context,
...
void service_mgr__internal_client_request_timeout(const constants__t_channel_i service_mgr__channel,
                                                  const constants__t_request_handle_i service_mgr__request_handle)
{
    {
        t_bool service_mgr__l_valid_req_handle;
        ...
        request_handle_bs__is_valid_req_handle(service_mgr__request_handle, &service_mgr__l_valid_req_handle);
        request_handle_bs__get_req_handle_channel(service_mgr__request_handle, &service_mgr__l_req_handle_channel);
        if ((service_mgr__l_valid_req_handle == true) && (service_mgr__l_req_handle_channel == service_mgr__channel))
        {
            request_handle_bs__get_req_handle_app_context(service_mgr__request_handle, &service_mgr__l_is_applicative,
                                                          &service_mgr__l_app_context);
            request_handle_bs__get_req_handle_req_typ(service_mgr__request_handle, &service_mgr__l_req_typ);
            request_handle_bs__client_remove_req_handle(service_mgr__request_handle);
            if (service_mgr__l_is_applicative == true)
            {
                service_response_cb_bs__cli_request_timeout(service_mgr__l_req_typ, service_mgr__l_app_context);
            }
        }
    }
}
