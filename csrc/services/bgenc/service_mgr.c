                ...
                if (service_mgr__l_is_valid_session_resp == true)
                {
                    ...
                    if (service_mgr__l_valid_resp_msg == true)
                    {
                        ...
                        service_response_cli_cb_bs__cli_service_response(
                            service_mgr__l_session, service_mgr__l_resp_msg, service_mgr__l_user_app_context);
            ...
            if (service_mgr__l_validated_req_handle == true)
            {
                ...
                if (service_mgr__l_valid_resp_msg == true)
                {
                    message_in_bs__copy_msg_resp_header_into_msg(service_mgr__l_resp_msg_header,
                                                                 service_mgr__l_resp_msg);
                    service_response_cli_cb_bs__cli_service_response(
                        constants__c_session_indet, service_mgr__l_resp_msg, service_mgr__l_user_app_context);
                    message_in_bs__forget_resp_msg_in(service_mgr__l_resp_msg_header, service_mgr__l_resp_msg);
                }
                else
                {
...
{
    {
        ...
        if (service_mgr__l_valid_msg == true)
        {
            ...
            case constants__e_msg_discovery_register_server2_req:
                ...
                message_out_bs__is_valid_msg_out_header(service_mgr__l_msg_header, &service_mgr__l_valid_msg_header);
                request_handle_bs__client_fresh_req_handle(service_mgr__l_resp_typ, service_mgr__app_context,
                                                           &service_mgr__l_req_handle);
                request_handle_bs__is_valid_req_handle(service_mgr__l_req_handle, &service_mgr__l_valid_req_handle);
...
void service_mgr__client_discovery_service_request(const constants__t_msg_i service_mgr__req_msg,
                                                   const constants__t_application_context_i service_mgr__app_context,
                                                   constants__t_StatusCode_i* const service_mgr__ret,
                                                   constants__t_byte_buffer_i* const service_mgr__buffer_out,
                                                   constants__t_request_handle_i* const service_mgr__req_handle)
...
{
    {
        ...
        if (service_mgr__l_valid_req_handle == true)
        {
            ...
            case constants__e_msg_session_cancel_resp:
                ...
                break;
            default:
                request_handle_bs__get_req_handle_app_context(service_mgr__request_handle, &service_mgr__l_app_context);
                request_handle_bs__client_remove_req_handle(service_mgr__request_handle);
                service_response_cli_cb_bs__cli_snd_failure(service_mgr__l_app_context, service_mgr__error_status);
                break;
            }
        }
    }
