...
{
    {
        ...
        channel_mgr__get_channel_info(session_core__channel, &session_core__l_channel_config_idx);
        channel_mgr__get_SecurityPolicy(session_core__channel, &session_core__l_secpol);
        if (session_core__l_secpol != constants__e_secpol_None)
        {
            session_core_1__server_activate_session_check_crypto(
                session_core__session, session_core__channel, session_core__l_channel_config_idx,
                session_core__activate_req_msg, session_core__res_activated);
            if (*session_core__res_activated == true)
            {
                session_core_1__get_NonceServer(session_core__session, &session_core__l_nonce);
        ...
        if (*session_core__res_activated == true)
        {
            session_core_1__set_session_user(session_core__session, session_core__user);
            session_core_1__set_session_channel(session_core__session, session_core__channel);
            session_core_1__set_session_state(session_core__session, constants__e_session_userActivated);
        }
    }
}
...
{
    session_core_1__init_new_session(session_core__nsession);
}
...
{
    {
        ...
        session_core_1__create_session(session_core__session, session_core__channel, constants__e_session_creating);
        channel_mgr__get_channel_info(session_core__channel, &session_core__l_channel_config_idx);
        session_core_1__client_create_session_req_do_crypto(session_core__session, session_core__channel,
                                                            session_core__l_channel_config_idx, session_core__valid,
        ...
        if (*session_core__valid == true)
        {
            ...
            {
                session_core_1__get_NonceClient(session_core__session, &session_core__l_nonce);
                message_out_bs__write_create_session_req_msg_crypto(
                    session_core__create_req_msg, session_core__l_channel_config_idx, session_core__l_nonce);
            }
        }
    }
}
...
{
    {
        ...
        *session_core__service_ret = constants__e_sc_bad_out_of_memory;
        session_core_1__init_new_session(&session_core__l_nsession);
        session_core_1__is_valid_session(session_core__l_nsession, &session_core__l_valid_session);
        if (session_core__l_valid_session == true)
        {
            session_core_1__create_session(session_core__l_nsession, session_core__channel,
                                           constants__e_session_created);
            session_core_1__server_get_fresh_session_token(session_core__l_nsession, &session_core__l_nsession_token);
            ...
            {
                channel_mgr__server_get_endpoint_config(session_core__channel, &session_core__l_endpoint_config_idx);
                message_out_bs__write_create_session_msg_session_token(session_core__create_resp_msg,
                                                                       session_core__l_nsession_token);
                message_out_bs__write_create_session_msg_server_endpoints(
                    session_core__create_req_msg, session_core__create_resp_msg, session_core__l_endpoint_config_idx,
                ...
                if (*session_core__service_ret == constants__e_sc_ok)
                {
                    ...
                    if (session_core__l_secpol != constants__e_secpol_None)
                    {
                        channel_mgr__get_channel_info(session_core__channel, &session_core__l_config_idx);
                        session_core_1__server_create_session_req_do_crypto(
                            session_core__l_nsession, session_core__create_req_msg, session_core__l_endpoint_config_idx,
                            session_core__l_config_idx, &session_core__l_valid_crypto, &session_core__l_signature);
                        if (session_core__l_valid_crypto == true)
                        {
                            session_core_1__get_NonceServer(session_core__l_nsession, &session_core__l_nonce);
                            message_out_bs__write_create_session_resp_msg_crypto(
                                session_core__create_resp_msg, session_core__l_config_idx, session_core__l_nonce,
                                session_core__l_signature, &session_core__l_bret);
            ...
            {
                *session_core__service_ret = constants__e_sc_bad_out_of_memory;
                session_core_1__delete_session(session_core__l_nsession);
        ...
        *session_core__bret = true;
        ...
        if (session_core__l_secpol != constants__e_secpol_None)
        {
            ...
            session_core_1__client_create_session_check_crypto(session_core__session,
                                                               session_core__l_channel_config_idx,
                                                               session_core__create_resp_msg, &session_core__l_valid);
            if (session_core__l_valid == true)
            {
                session_core_1__set_session_state(session_core__session, constants__e_session_created);
                session_core_1__client_set_session_token(session_core__session, session_core__session_token);
...
{
    {
        ...
        session_core_1__get_session_channel(session_core__session, session_core__channel);
        channel_mgr__is_connected_channel(*session_core__channel, &session_core__l_is_connected_channel);
        if (session_core__l_is_connected_channel == true)
        {
            session_core_1__client_get_token_from_session(session_core__session, session_core__session_token);
            channel_mgr__get_channel_info(*session_core__channel, &session_core__l_channel_config_idx);
            message_out_bs__write_activate_msg_user(session_core__activate_req_msg, session_core__user);
            channel_mgr__get_SecurityPolicy(*session_core__channel, &session_core__l_secpol);
            if (session_core__l_secpol != constants__e_secpol_None)
            {
                session_core_1__get_NonceServer(session_core__session, &session_core__l_server_nonce);
                session_core_1__client_activate_session_req_do_crypto(
                    session_core__session, session_core__l_channel_config_idx, session_core__l_server_nonce,
                    &session_core__l_valid_crypto, &session_core__l_signature);
                if (session_core__l_valid_crypto == true)
                {
                    message_out_bs__write_activate_session_req_msg_crypto(
                        session_core__activate_req_msg, session_core__l_signature, &session_core__l_bret);
        ...
        {
            session_core_1__set_session_user(session_core__session, session_core__user);
            session_core_1__set_session_state(session_core__session, constants__e_session_userActivating);
        }
    }
}
...
{
    {
        ...
        session_core_1__client_get_token_from_session(session_core__session, session_core__session_token);
        session_core_1__get_session_user(session_core__session, &session_core__l_user);
        message_out_bs__write_activate_msg_user(session_core__activate_req_msg, session_core__l_user);
        session_core_1__set_session_channel(session_core__session, session_core__channel);
        session_core_1__set_session_state(session_core__session, constants__e_session_scActivating);
    }
}
...
{
    {
        ...
        session_core_1__get_session_channel(session_core__session, &session_core__l_channel);
        session_core_1__get_session_user(session_core__session, &session_core__l_user);
        session_core_1__get_session_state(session_core__session, &session_core__l_state);
        if (session_core__l_state == constants__e_session_created)
        {
            if (session_core__l_channel == session_core__channel)
            {
                session_core__server_internal_activate_req_and_resp(
                    session_core__channel, session_core__session, session_core__user, session_core__activate_req_msg,
                    session_core__activate_resp_msg, &session_core__l_valid);
                if (session_core__l_valid == true)
                {
        ...
        {
            if ((session_core__l_channel == session_core__channel) && (session_core__l_user != session_core__user))
            {
                session_core__server_internal_activate_req_and_resp(
                    session_core__channel, session_core__session, session_core__user, session_core__activate_req_msg,
                    session_core__activate_resp_msg, &session_core__l_valid);
            ...
            else if ((session_core__l_channel != session_core__channel) && (session_core__l_user == session_core__user))
            {
                session_core__server_internal_activate_req_and_resp(
                    session_core__channel, session_core__session, session_core__user, session_core__activate_req_msg,
                    session_core__activate_resp_msg, &session_core__l_valid);
...
{
    {
        ...
        channel_mgr__get_channel_info(session_core__channel, &session_core__l_channel_config_idx);
        session_core_1__client_activate_session_resp_check(session_core__session, session_core__l_channel_config_idx,
...
{
    {
        ...
        {
            session_core_it__continue_iter_session(&session_core__l_continue, &session_core__l_session);
            session_core_1__getall_session_channel(session_core__l_session, &session_core__l_dom,
                                                   &session_core__l_channel);
            if ((session_core__l_dom == true) && (session_core__l_channel == session_core__lost_channel))
            {
                session_core_1__get_session_state(session_core__l_session, &session_core__l_state);
                ...
                {
                    session_core_1__set_session_orphaned(session_core__l_session, session_core__channel_config_idx);
                    session_core_1__set_session_state(session_core__l_session, constants__e_session_scOrphaned);
                }
                else
                {
                    session_core_1__set_session_state_closed(session_core__l_session, true);
                }
            }
        }
    }
...
void session_core__server_secure_channel_lost_session_sm(const constants__t_channel_i session_core__channel)
{
    {
        t_bool session_core__l_continue;
        constants__t_session_i session_core__l_session;
        ...
        while (session_core__l_continue == true)
        {
            ...
            session_core_1__getall_session_channel(session_core__l_session, &session_core__l_dom,
                                                   &session_core__l_channel);
            if ((session_core__l_dom == true) && (session_core__l_channel == session_core__channel))
            {
                session_core_1__get_session_state(session_core__l_session, &session_core__l_state);
                if (session_core__l_state == constants__e_session_userActivated)
                {
                    session_core_1__set_session_orphaned(session_core__l_session,
                                                         constants__c_channel_config_idx_indet);
                    session_core_1__set_session_state(session_core__l_session, constants__e_session_scOrphaned);
                }
                else
                {
                    session_core_1__set_session_state_closed(session_core__l_session, false);
                }
            }
        }
    }
...
{
    {
        ...
        {
            session_core_1__client_get_token_from_session(session_core__session, session_core__session_token);
            session_core_1__set_session_state(session_core__session, constants__e_session_closing);
            *session_core__ret = constants__e_sc_ok;
        }
        else
        {
                                                        ...
                                                        constants__t_StatusCode_i* const session_core__ret)
{
    ...
    session_core_1__server_close_session_check_req(session_core__close_req_msg, session_core__close_resp_msg);
    session_core_1__set_session_state_closed(session_core__session, false);
    *session_core__ret = constants__e_sc_ok;
}
                                                ...
                                                const constants__t_msg_i session_core__close_resp_msg)
{
    ...
    session_core_1__set_session_state_closed(session_core__session, true);
}
...
{
    {
        ...
        session_core_1__is_valid_session(session_core__session, &session_core__l_valid_session);
        if (session_core__l_valid_session == true)
        {
            session_core_1__get_session_state(session_core__session, session_core__state);
        }
        else
        {
...
void session_core__get_session_user_or_indet(const constants__t_session_i session_core__session,
...
{
    {
        ...
        *session_core__user = constants__c_user_indet;
        ...
        if (session_core__l_valid_session == true)
        {
            session_core_1__get_session_state(session_core__session, &session_core__l_session_state);
            ...
            {
                session_core_1__get_session_user(session_core__session, session_core__user);
            }
        }
    }
}
