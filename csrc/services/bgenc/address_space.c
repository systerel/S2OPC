...
{
    {
        ...
        *address_space__StatusCode_service = constants__e_sc_ok;
        ...
        while (address_space__l_continue == true)
        {
            ...
            {
                service_write_decode_bs__getAndClean_WriteValuePointer(address_space__l_wvi, &address_space__l_wv);
                service_response_cb_bs__srv_write_notification(address_space__l_wv, address_space__l_status2);
            }
        }
    }
}
