...
extern void session_core_bs__client_activate_session_resp_check(
    ...
    t_bool* const session_core_bs__valid);
extern void session_core_bs__client_close_session_req_msg(const constants__t_msg_i session_core_bs__req_msg);
extern void session_core_bs__client_close_session_resp_msg(const constants__t_msg_i session_core_bs__resp_msg);
...
extern void session_core_bs__client_set_session_token(const constants__t_session_i session_core_bs__session,
                                                      const constants__t_session_token_i session_core_bs__token);
extern void session_core_bs__delete_session_token(const constants__t_session_i session_core_bs__p_session);
extern void session_core_bs__drop_NonceClient(const constants__t_session_i session_core_bs__p_session);
extern void session_core_bs__get_NonceClient(const constants__t_session_i session_core_bs__p_session,
                                             constants__t_Nonce_i* const session_core_bs__nonce);
extern void session_core_bs__get_NonceServer(const constants__t_session_i session_core_bs__p_session,
                                             constants__t_Nonce_i* const session_core_bs__nonce);
extern void session_core_bs__get_session_user(const constants__t_session_i session_core_bs__session,
                                              constants__t_user_i* const session_core_bs__user);
extern void session_core_bs__getall_to_activate(const constants__t_session_i session_core_bs__p_session,
                                                t_bool* const session_core_bs__p_dom,
                                                constants__t_user_i* const session_core_bs__p_user);
extern void session_core_bs__is_valid_user(const constants__t_user_i session_core_bs__user,
                                           t_bool* const session_core_bs__ret);
extern void session_core_bs__notify_set_session_state(const constants__t_session_i session_core_bs__session,
                                                      const constants__t_sessionState session_core_bs__prec_state,
                                                      const constants__t_sessionState session_core_bs__state);
extern void session_core_bs__prepare_close_session(const constants__t_session_i session_core_bs__session,
                                                   const constants__t_sessionState session_core_bs__state,
                                                   const t_bool session_core_bs__is_client);
extern void session_core_bs__reset_session_to_activate(const constants__t_session_i session_core_bs__p_session);
extern void session_core_bs__server_activate_session_check_crypto(
    ...
    t_bool* const session_core_bs__valid);
extern void session_core_bs__server_close_session_check_req(const constants__t_msg_i session_core_bs__req_msg,
...
extern void session_core_bs__server_create_session_req_do_crypto(
    ...
    t_bool* const session_core_bs__valid,
    constants__t_SignatureData_i* const session_core_bs__signature);
extern void session_core_bs__server_get_fresh_session_token(const constants__t_session_i session_core_bs__session,
...
extern void session_core_bs__server_is_valid_session_token(const constants__t_session_token_i session_core_bs__token,
                                                           t_bool* const session_core_bs__ret);
extern void session_core_bs__session_do_nothing(const constants__t_session_i session_core_bs__session);
extern void session_core_bs__set_session_to_activate(const constants__t_session_i session_core_bs__p_session,
                                                     const constants__t_user_i session_core_bs__p_user);
extern void session_core_bs__set_session_user(const constants__t_session_i session_core_bs__session,
                                              const constants__t_user_i session_core_bs__user);
