 ...
 */
typedef SOPC_StatusCode (*SOPC_Method_Func)(SOPC_NodeId* objectId,
...
typedef SOPC_Method_Func (*SOPC_MethodCallManager_Get_Func)(SOPC_MethodCallManager* mcm, SOPC_NodeId* methodId);
