...
struct SOPC_PKIProvider
{
     ...
     * assumes that a STATUS_OK from this function means that the certificate can be trusted. Parameters are validated
     * by CryptoProvider_Certificate_Validate().
     *
     *  \param pPKI     A valid pointer to the PKIProvider.
     *  \param pToValidate  A valid pointer to the Certificate to validate.
     *
     *  \return         STATUS_OK when the certificate is successfully validated, and STATUS_INVALID_PARAMETERS or
     * STATUS_NOK.
     */
