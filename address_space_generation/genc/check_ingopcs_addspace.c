...
bool test_browsename(void)
{
    ...
    if (addressSpace.browseNameArray[29].NamespaceIndex != 261)
    {
        printf("invalid BrowseName ");
    }
    var = "15361";
    ...
    if (addressSpace.browseNameArray[51].NamespaceIndex != 0)
    {
        printf("invalid BrowseName ");
    }
    var = "State";
    ...
    if (addressSpace.browseNameArray[66].NamespaceIndex != 261)
    {
        printf("invalid BrowseName ");
    }
    var = "GK";
    ...
    if (addressSpace.browseNameArray[67].NamespaceIndex != 261)
    {
        printf("invalid BrowseName ");
    }
    var = "ASK";
    ...
    if (addressSpace.browseNameArray[99].NamespaceIndex != 0)
    {
        printf("invalid BrowseName ");
    }
    ...
    if (addressSpace.browseNameArray[100].NamespaceIndex != 0)
    {
        printf("invalid BrowseName ");
    }
