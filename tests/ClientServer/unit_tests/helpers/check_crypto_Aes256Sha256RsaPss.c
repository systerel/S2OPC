...
/** \file
 *
 * \brief Cryptographic test suite. This suite tests "http://opcfoundation.org/UA/SecurityPolicy#Aes256_Sha256_RsaPss".
 *
...
{
    crypto = SOPC_CryptoProvider_Create(SOPC_SecurityPolicy_Aes256Sha256RsaPss_URI);
...
START_TEST(test_crypto_load_Aes256Sha256RsaPss)
{
    ...
    ck_assert(SOPC_SecurityPolicy_Aes256Sha256RsaPss_ID == profile->SecurityPolicyID);
...
START_TEST(test_crypto_symm_lengths_Aes256Sha256RsaPss)
{
...
START_TEST(test_crypto_symm_crypt_Aes256Sha256RsaPss)
{
    ...
    status = SOPC_HelperDecode_Hex("c47b0294dbbbee0fec4757f22ffeee3587ca4730c3d33b691df38bab076bc558", key, 32);
    ck_assert_int_eq(SOPC_STATUS_OK, status);
    pSecKey = SOPC_SecretBuffer_NewFromExposedBuffer(key, sizeof(key));
    ck_assert(NULL != pSecKey);
    memset(iv, 0, sizeof(iv));
    ...
    status = SOPC_HelperDecode_Hex("ccd1bc3c659cd3c59bc437484e3c5c724441da8d6e90ce556cd57d0752663bbc", key, 32);
    ck_assert_int_eq(SOPC_STATUS_OK, status);
    pSecKey = SOPC_SecretBuffer_NewFromExposedBuffer(key, sizeof(key));
    ck_assert(NULL != pSecKey);
    memset(iv, 0, sizeof(iv));
    ...
    pSecIV = SOPC_SecretBuffer_NewFromExposedBuffer(iv, sizeof(iv));
    ck_assert(NULL != pSecIV);
    status = SOPC_HelperDecode_Hex("0b24af36193ce4665f2825d7b4749c98", input, 16);
    ck_assert_int_eq(SOPC_STATUS_OK, status);
    memset(output, 0, sizeof(output));
    ck_assert(SOPC_CryptoProvider_SymmetricEncrypt(crypto, input, 16, pSecKey, pSecIV, output, 16) == SOPC_STATUS_OK);
    status = SOPC_HelperEncode_Hex(output, hexoutput, 16);
    ...
    memset(key, 0, sizeof(key));
    status = SOPC_HelperDecode_Hex("458b67bf212d20f3a57fce392065582dcefbf381aa22949f8338ab9052260e1d", key, 32);
    ck_assert_int_eq(SOPC_STATUS_OK, status);
    pSecKey = SOPC_SecretBuffer_NewFromExposedBuffer(key, sizeof(key));
    ck_assert(NULL != pSecKey);
    memset(iv, 0, sizeof(iv));
    status = SOPC_HelperDecode_Hex("4c12effc5963d40459602675153e9649", iv, 16);
    ck_assert_int_eq(SOPC_STATUS_OK, status);
    pSecIV = SOPC_SecretBuffer_NewFromExposedBuffer(iv, sizeof(iv));
    ck_assert(NULL != pSecIV);
    status = SOPC_HelperDecode_Hex("256fd73ce35ae3ea9c25dd2a9454493e", input, 16);
    ck_assert_int_eq(SOPC_STATUS_OK, status);
    memset(output, 0, sizeof(output));
    ck_assert(SOPC_CryptoProvider_SymmetricEncrypt(crypto, input, 16, pSecKey, pSecIV, output, 16) == SOPC_STATUS_OK);
    status = SOPC_HelperEncode_Hex(output, hexoutput, 16);
    ...
    // Decrypt
    status = SOPC_HelperDecode_Hex("28d46cffa158533194214a91e712fc2b45b518076675affd910edeca5f41ac64", key, 32);
    ck_assert_int_eq(SOPC_STATUS_OK, status);
    pSecKey = SOPC_SecretBuffer_NewFromExposedBuffer(key, sizeof(key));
    ck_assert(NULL != pSecKey);
    memset(iv, 0, sizeof(iv));
    pSecIV = SOPC_SecretBuffer_NewFromExposedBuffer(iv, sizeof(iv));
    ck_assert(NULL != pSecIV);
    status = SOPC_HelperDecode_Hex("4bf3b0a69aeb6657794f2901b1440ad4", input, 16);
    ck_assert_int_eq(SOPC_STATUS_OK, status);
    memset(output, 0, sizeof(output));
    ...
    status = SOPC_HelperDecode_Hex("07eb03a08d291d1b07408bf3512ab40c91097ac77461aad4bb859647f74f00ee", key, 32);
    ck_assert_int_eq(SOPC_STATUS_OK, status);
    pSecKey = SOPC_SecretBuffer_NewFromExposedBuffer(key, sizeof(key));
    ck_assert(NULL != pSecKey);
    memset(iv, 0, sizeof(iv));
    pSecIV = SOPC_SecretBuffer_NewFromExposedBuffer(iv, sizeof(iv));
    ck_assert(NULL != pSecIV);
    status = SOPC_HelperDecode_Hex("47cb030da2ab051dfc6c4bf6910d12bb", input, 16);
    ck_assert_int_eq(SOPC_STATUS_OK, status);
    memset(output, 0, sizeof(output));
    ck_assert(SOPC_CryptoProvider_SymmetricDecrypt(crypto, input, 16, pSecKey, pSecIV, output, 16) == SOPC_STATUS_OK);
    for (i = 0; i < 16; ++i)
    ...
    pSecIV = SOPC_SecretBuffer_NewFromExposedBuffer(iv, sizeof(iv));
    ck_assert(NULL != pSecIV);
    status = SOPC_HelperDecode_Hex("623a52fcea5d443e48d9181ab32c7421", input, 16);
    ck_assert_int_eq(SOPC_STATUS_OK, status);
    memset(output, 0, sizeof(output));
    ck_assert(SOPC_CryptoProvider_SymmetricDecrypt(crypto, input, 16, pSecKey, pSecIV, output, 16) == SOPC_STATUS_OK);
    status = SOPC_HelperEncode_Hex(output, hexoutput, 16);
    ...
    pSecIV = SOPC_SecretBuffer_NewFromExposedBuffer(iv, sizeof(iv));
    ck_assert(NULL != pSecIV);
    status = SOPC_HelperDecode_Hex("90b7b9630a2378f53f501ab7beff0391", input, 16);
    ck_assert_int_eq(SOPC_STATUS_OK, status);
    memset(output, 0, sizeof(output));
    ck_assert(SOPC_CryptoProvider_SymmetricDecrypt(crypto, input, 16, pSecKey, pSecIV, output, 16) == SOPC_STATUS_OK);
    status = SOPC_HelperEncode_Hex(output, hexoutput, 16);
    ...
    status = SOPC_HelperDecode_Hex(
        "256fd73ce35ae3ea9c25dd2a9454493e96d8633fe633b56176dce8785ce5dbbb84dbf2c8a2eeb1e96b51899605e4f1"
...
START_TEST(test_crypto_symm_sign_Aes256Sha256RsaPss)
{
    ...
    // Test cases of https://tools.ietf.org/html/rfc4231 cannot be used for Aes256Sha256RsaPss
 ...
 */
START_TEST(test_crypto_generate_nbytes_Aes256Sha256RsaPss)
{
...
START_TEST(test_crypto_generate_nonce_Aes256Sha256RsaPss)
{
...
START_TEST(test_crypto_generate_uint32_Aes256Sha256RsaPss)
{
    uint32_t i = 0, j = 0;
...
START_TEST(test_crypto_derive_lengths_Aes256Sha256RsaPss)
{
...
START_TEST(test_crypto_derive_data_Aes256Sha256RsaPss)
{
...
START_TEST(test_crypto_derive_keysets_Aes256Sha256RsaPss)
{
...
START_TEST(test_cert_load_Aes256Sha256RsaPss)
{
    ;
}
END_TEST

START_TEST(test_cert_lengths_Aes256Sha256RsaPss)
{
    uint32_t len = 0;
...
START_TEST(test_cert_loadkey_Aes256Sha256RsaPss)
{
...
START_TEST(test_crypto_asym_load_Aes256Sha256RsaPss)
{
    ;
}
END_TEST

START_TEST(test_crypto_asym_lengths_Aes256Sha256RsaPss)
{
    ...
    ck_assert(190 == lenPlain); // 256 - 2*32 - 2
    ...
    ck_assert(190 == len);
    ck_assert(SOPC_CryptoProvider_AsymmetricGetLength_Encryption(crypto, key_pub, 760, &len) == SOPC_STATUS_OK);
    ck_assert(1024 == len);
...
START_TEST(test_crypto_asym_crypt_Aes256Sha256RsaPss)
{
    ...
    ck_assert(SOPC_CryptoProvider_AsymmetricEncrypt(crypto, input, 32, key_pub, output, 256, &errorReason) ==
              SOPC_STATUS_OK);
    ck_assert(SOPC_CryptoProvider_AsymmetricDecrypt(crypto, output, 256, key_priv, input_bis, 190, &len,
                                                    &errorReason) == SOPC_STATUS_OK);
    ck_assert(len == 32);
    ck_assert(memcmp(input, input_bis, 32) == 0);
    // b) Multiple messages (> 190, and as output is 1024, < 760)
    //  Using previously generated nonce, to fill input[32:760]
    ...
    ck_assert(SOPC_CryptoProvider_DerivePseudoRandomData(crypto, clientNonce, 32, serverNonce, 32, input + 32,
                                                         760 - 32) == SOPC_STATUS_OK);
    ck_assert(SOPC_CryptoProvider_AsymmetricEncrypt(crypto, input, 760, key_pub, output, 1024, &errorReason) ==
              SOPC_STATUS_OK);
    ck_assert(SOPC_CryptoProvider_AsymmetricDecrypt(crypto, output, 1024, key_priv, input_bis, 760, &len,
                                                    &errorReason) == SOPC_STATUS_OK);
    ck_assert(len == 760);
    ck_assert(memcmp(input, input_bis, 760) == 0);
}
END_TEST

START_TEST(test_crypto_asym_sign_verify_Aes256Sha256RsaPss)
{
    ...
    ck_assert(SOPC_CryptoProvider_AsymmetricVerify(crypto, input, 32, key_pub, sig, 256, &errorReason) ==
              SOPC_STATUS_OK);
    // b) Multiple messages (> 190, and as output is 1024, < 856)
...
START_TEST(test_crypto_asym_copykey_Aes256Sha256RsaPss)
{
...
START_TEST(test_crypto_asym_uri_Aes256Sha256RsaPss)
{
    int res = strncmp(SOPC_CryptoProvider_AsymmetricGetUri_SignAlgorithm(crypto),
                      ...
                      strlen(SOPC_SecurityPolicy_Aes256Sha256RsaPss_URI_SignAlgo) + 1);
...
START_TEST(test_pki_cert_validation_Aes256Sha256RsaPss)
{
...
START_TEST(test_cert_copyder_Aes256Sha256RsaPss)
{
...
Suite* tests_make_suite_crypto_Aes256Sha256RsaPss(void)
{
    ...
    s = suite_create("Crypto tests Aes256Sha256RsaPss");
    ...
    tcase_add_test(tc_crypto_symm, test_crypto_load_Aes256Sha256RsaPss);
    tcase_add_test(tc_crypto_symm, test_crypto_symm_lengths_Aes256Sha256RsaPss);
    tcase_add_test(tc_crypto_symm, test_crypto_symm_crypt_Aes256Sha256RsaPss);
    tcase_add_test(tc_crypto_symm, test_crypto_symm_sign_Aes256Sha256RsaPss);

    suite_add_tcase(s, tc_rands);
    tcase_add_checked_fixture(tc_rands, setup_crypto, teardown_crypto);
    tcase_add_test(tc_rands, test_crypto_generate_nbytes_Aes256Sha256RsaPss);
    tcase_add_test(tc_rands, test_crypto_generate_nonce_Aes256Sha256RsaPss);
    tcase_add_test(tc_rands, test_crypto_generate_uint32_Aes256Sha256RsaPss);
    ...
    tcase_add_test(tc_derives, test_crypto_derive_lengths_Aes256Sha256RsaPss);
    tcase_add_test(tc_derives, test_crypto_derive_data_Aes256Sha256RsaPss);
    tcase_add_test(tc_derives, test_crypto_derive_keysets_Aes256Sha256RsaPss);
    ...
    tcase_add_test(tc_km, test_cert_load_Aes256Sha256RsaPss);
    tcase_add_test(tc_km, test_cert_lengths_Aes256Sha256RsaPss);
    tcase_add_test(tc_km, test_cert_thumbprint_Aes256Sha256RsaPss);
    tcase_add_test(tc_km, test_cert_loadkey_Aes256Sha256RsaPss);
    tcase_add_test(tc_km, test_cert_copyder_Aes256Sha256RsaPss);

    suite_add_tcase(s, tc_crypto_asym);
    tcase_add_checked_fixture(tc_crypto_asym, setup_asym_keys, teardown_asym_keys);
    tcase_add_test(tc_crypto_asym, test_crypto_asym_load_Aes256Sha256RsaPss);
    tcase_add_test(tc_crypto_asym, test_crypto_asym_lengths_Aes256Sha256RsaPss);
    tcase_add_test(tc_crypto_asym, test_crypto_asym_crypt_Aes256Sha256RsaPss);
    tcase_add_test(tc_crypto_asym, test_crypto_asym_sign_verify_Aes256Sha256RsaPss);
    tcase_add_test(tc_crypto_asym, test_crypto_asym_copykey_Aes256Sha256RsaPss);
    tcase_add_test(tc_crypto_asym, test_crypto_asym_uri_Aes256Sha256RsaPss);

    suite_add_tcase(s, tc_pki_stack);
    tcase_add_checked_fixture(tc_pki_stack, setup_pki_stack, teardown_pki_stack);
    tcase_add_test(tc_pki_stack, test_pki_cert_validation_Aes256Sha256RsaPss);
