...
#define P_LOG_SRV_TX_PERIOD (100)
...
#define P_LOG_FIFO_ELT_MAX_SIZE_CLT_TX (128)
#define P_LOG_FIFO_MAX_NB_ELT_CLT_TX (128)

#define P_LOG_FIFO_DATA_SIZE_CLT_RX (4096)
...
#define ENCODER_RX_BUFFER_SIZE (P_LOG_FIFO_ELT_MAX_SIZE_CLT_TX)
