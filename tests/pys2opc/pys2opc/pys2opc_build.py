...
ffibuilder.cdef(header + r'''
    extern "Python" void log_libsub(SOPC_Toolkit_Log_Level log_level, SOPC_LibSub_CstString text);
    extern "Python" void disconnected(SOPC_LibSub_ConnectionId c_id);
    extern "Python" void datachanged(SOPC_LibSub_ConnectionId c_id, SOPC_LibSub_DataId d_id, SOPC_LibSub_Value* value);
    extern "Python" void generic_event(SOPC_LibSub_ConnectionId c_id, SOPC_LibSub_ApplicativeEvent event, SOPC_StatusCode status, const void* response, uintptr_t responseContext);
''')
