...
static char* default_trusted_root_issuers[] = {"trusted/cacert.der", "trusted/ctt_ca1T.der" /* Tests 029, 037 */,
                                               // "trusted/ctt_ca1I_ca2T.der", /* Cannot be used without CRL */
                                               NULL};
...
static char* default_issued_certs[] = {"issued/ctt_appT.der", /* Test 048 */
                                       ...
                                       "issued/ctt_appTSincorrect.der",
                                       "issued/ctt_appTSip.der",
                                       "issued/ctt_appTSuri.der",
                                       "issued/ctt_appTV.der",
                                       ...
                                       "issued/ctt_ca1TC_ca2I_appT.der",
                                       "issued/ctt_ca1TC_ca2I_appTR.der",
                                       "issued/ctt_ca1U_appT.der",
                                       "issued/ctt_ca1U_appTR.der",
                                       NULL};
static char* default_untrusted_root_issuers[] = {"untrusted/ctt_ca1I.der" /* Test 044 */,
                                                 "untrusted/ctt_ca1TC_ca2I.der",
                                                 // "untrusted/ctt_ca1IC.der", /* Cannot be used without CRL */
                                                 NULL};
